...
main(void)
{
  ...
  exit();
      ...
      d3:	00 
      d4:	c7 44 24 04 61 13 00 	movl   $0x1361,0x4(%esp)
      db:	00 
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     254:	c7 44 24 04 c7 12 00 	movl   $0x12c7,0x4(%esp)
     25b:	00 
     25c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     263:	89 44 24 08          	mov    %eax,0x8(%esp)
     267:	e8 e4 0c 00 00       	call   f50 <printf>
    break;
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     37e:	e8 4d 0e 00 00       	call   11d0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3be:	e8 0d 0e 00 00       	call   11d0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     41e:	e8 ad 0d 00 00       	call   11d0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     46e:	e8 5d 0d 00 00       	call   11d0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4be:	e8 0d 0d 00 00       	call   11d0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     509:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     52a:	c7 04 24 40 19 00 00 	movl   $0x1940,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     57a:	c7 04 24 40 19 00 00 	movl   $0x1940,(%esp)
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5cb:	c7 04 24 38 19 00 00 	movl   $0x1938,(%esp)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5ed:	c7 04 24 40 19 00 00 	movl   $0x1940,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     662:	c7 04 24 40 19 00 00 	movl   $0x1940,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     6b0:	c7 44 24 08 09 13 00 	movl   $0x1309,0x8(%esp)
     6b7:	00 
  ...
  return cmd;
     ...
     772:	c3                   	ret    
      panic("missing file for redirection");
     773:	c7 04 24 ec 12 00 00 	movl   $0x12ec,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     78f:	c7 44 24 08 0c 13 00 	movl   $0x130c,0x8(%esp)
     796:	00 
  ...
  while(!peek(ps, es, "|)&;")){
     7ee:	c7 44 24 08 23 13 00 	movl   $0x1323,0x8(%esp)
     7f5:	00 
    ...
    if(argc >= MAXARGS)
     ...
     83f:	75 97                	jne    7d8 <parseexec+0x58>
      panic("too many args");
     841:	c7 04 24 15 13 00 00 	movl   $0x1315,(%esp)
  ...
  return ret;
     ...
     889:	c3                   	ret    
      panic("syntax");
     88a:	c7 04 24 0e 13 00 00 	movl   $0x130e,(%esp)
...
000008a0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     8bb:	c7 44 24 08 28 13 00 	movl   $0x1328,0x8(%esp)
     8c2:	00 
...
00000920 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     966:	c7 44 24 08 2a 13 00 	movl   $0x132a,0x8(%esp)
     96d:	00 
  ...
  if(peek(ps, es, ";")){
     97e:	c7 44 24 08 26 13 00 	movl   $0x1326,0x8(%esp)
     985:	00 
...
000009e0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     9ef:	c7 44 24 08 0c 13 00 	movl   $0x130c,0x8(%esp)
     9f6:	00 
  ...
  if(!peek(ps, es, ")"))
     a2f:	c7 44 24 08 48 13 00 	movl   $0x1348,0x8(%esp)
     a36:	00 
  ...
  cmd = parseredirs(cmd, ps, es);
     ...
     a7c:	c3                   	ret    
    panic("parseblock");
     a7d:	c7 04 24 2c 13 00 00 	movl   $0x132c,(%esp)
     a84:	e8 d7 f6 ff ff       	call   160 <panic>
    panic("syntax - missing )");
     a89:	c7 04 24 37 13 00 00 	movl   $0x1337,(%esp)
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ab9:	ff 24 85 88 13 00 00 	jmp    *0x1388(,%eax,4)
...
00000b50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     b74:	c7 44 24 08 d6 12 00 	movl   $0x12d6,0x8(%esp)
     b7b:	00 
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     ba9:	c7 44 24 04 4a 13 00 	movl   $0x134a,0x4(%esp)
     bb0:	00 
     bb1:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     bb8:	e8 93 03 00 00       	call   f50 <printf>
    panic("syntax");
     bbd:	c7 04 24 0e 13 00 00 	movl   $0x130e,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  write(fd, &c, 1);
     ...
     f2a:	e8 e3 fe ff ff       	call   e12 <write>
  while(--i >= 0)
     ...
     f5e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  write(fd, &c, 1);
     f96:	e8 77 fe ff ff       	call   e12 <write>
  ...
  write(fd, &c, 1);
    ...
    1006:	e8 07 fe ff ff       	call   e12 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    1023:	e8 ea fd ff ff       	call   e12 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    10b0:	e8 5d fd ff ff       	call   e12 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    10e0:	e8 2d fd ff ff       	call   e12 <write>
  ...
  write(fd, &c, 1);
    ...
    1130:	e8 dd fc ff ff       	call   e12 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    123a:	e8 3b fc ff ff       	call   e7a <sbrk>
  if(p == (char*)-1)
