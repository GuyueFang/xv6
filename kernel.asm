...
8010004c:	c7 44 24 04 40 70 10 	movl   $0x80107040,0x4(%esp)
80100053:	80 
80100054:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
8010005b:	e8 60 43 00 00       	call   801043c0 <initlock>
  bcache.head.next = &bcache.head;
...
80100094:	c7 44 24 04 47 70 10 	movl   $0x80107047,0x4(%esp)
8010009b:	80 
...
801000e3:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000e6:	e8 45 44 00 00       	call   80104530 <acquire>
...
80100161:	e8 3a 44 00 00       	call   801045a0 <release>
      acquiresleep(&b->lock);
...
80100188:	c7 04 24 4e 70 10 80 	movl   $0x8010704e,(%esp)
...
801001c4:	e9 57 1f 00 00       	jmp    80102120 <iderw>
    panic("bwrite");
801001c9:	c7 04 24 5f 70 10 80 	movl   $0x8010705f,(%esp)
...
80100209:	e8 22 43 00 00       	call   80104530 <acquire>
  b->refcnt--;
  if (b->refcnt == 0) {
...
8010024f:	5d                   	pop    %ebp
  release(&bcache.lock);
80100250:	e9 4b 43 00 00       	jmp    801045a0 <release>
    panic("brelse");
80100255:	c7 04 24 66 70 10 80 	movl   $0x80107066,(%esp)
...
8010028e:	e8 9d 42 00 00       	call   80104530 <acquire>
  while(n > 0){
...
80100311:	e8 8a 42 00 00       	call   801045a0 <release>
  ilock(ip);
...
8010032f:	e8 6c 42 00 00       	call   801045a0 <release>
        ilock(ip);
...
8010037e:	c7 04 24 6d 70 10 80 	movl   $0x8010706d,(%esp)
...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 c3 79 10 80 	movl   $0x801079c3,(%esp)
801003a0:	e8 ab 02 00 00       	call   80100650 <cprintf>
  getcallerpcs(&s, pcs);
801003a5:	8d 45 08             	lea    0x8(%ebp),%eax
801003a8:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801003ac:	89 04 24             	mov    %eax,(%esp)
801003af:	e8 2c 40 00 00       	call   801043e0 <getcallerpcs>
801003b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf(" %p", pcs[i]);
801003b8:	8b 03                	mov    (%ebx),%eax
801003ba:	83 c3 04             	add    $0x4,%ebx
801003bd:	c7 04 24 81 70 10 80 	movl   $0x80107081,(%esp)
...
80100409:	e8 92 57 00 00       	call   80105ba0 <uartputc>
...
801004b9:	e8 e2 56 00 00       	call   80105ba0 <uartputc>
801004be:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004c5:	e8 d6 56 00 00       	call   80105ba0 <uartputc>
801004ca:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004d1:	e8 ca 56 00 00       	call   80105ba0 <uartputc>
...
801004fc:	e8 8f 41 00 00       	call   80104690 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100518:	00 
80100519:	e8 d2 40 00 00       	call   801045f0 <memset>
8010051e:	89 f1                	mov    %esi,%ecx
80100520:	be 07 00 00 00       	mov    $0x7,%esi
80100525:	e9 59 ff ff ff       	jmp    80100483 <consputc+0xa3>
    panic("pos under/overflow");
8010052a:	c7 04 24 85 70 10 80 	movl   $0x80107085,(%esp)
...
80100599:	0f b6 92 b0 70 10 80 	movzbl -0x7fef8f50(%edx),%edx
  }while((x /= base) != 0);
...
8010060e:	e8 1d 3f 00 00       	call   80104530 <acquire>
...
80100636:	e8 65 3f 00 00       	call   801045a0 <release>
  ilock(ip);
...
801006f3:	e8 a8 3e 00 00       	call   801045a0 <release>
}
...
8010075d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        s = "(null)";
80100760:	b8 98 70 10 80       	mov    $0x80107098,%eax
...
80100797:	e8 94 3d 00 00       	call   80104530 <acquire>
8010079c:	e9 c8 fe ff ff       	jmp    80100669 <cprintf+0x19>
    panic("null fmt");
801007a1:	c7 04 24 9f 70 10 80 	movl   $0x8010709f,(%esp)
...
801007c5:	e8 66 3d 00 00       	call   80104530 <acquire>
...
80100827:	e8 74 3d 00 00       	call   801045a0 <release>
  if(doprocdump) {
...
801008ad:	a3 a4 ff 10 80       	mov    %eax,0x8010ffa4
          wakeup(&input.r);
801008b2:	e8 89 35 00 00       	call   80103e40 <wakeup>
...
80100956:	c7 44 24 04 a8 70 10 	movl   $0x801070a8,0x4(%esp)
8010095d:	80 
8010095e:	c7 04 24 20 a5 10 80 	movl   $0x8010a520,(%esp)
80100965:	e8 56 3a 00 00       	call   801043c0 <initlock>
...
80100b93:	e8 e8 1f 00 00       	call   80102b80 <end_op>
    cprintf("exec: fail\n");
80100b98:	c7 04 24 c1 70 10 80 	movl   $0x801070c1,(%esp)
...
80100bc8:	e8 73 62 00 00       	call   80106e40 <clearpteu>
...
80100c12:	e8 f9 3b 00 00       	call   80104810 <strlen>
...
80100c31:	e8 6a 63 00 00       	call   80106fa0 <copyout>
...
80100c9e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca4:	e8 f7 62 00 00       	call   80106fa0 <copyout>
...
80100cf1:	e8 da 3a 00 00       	call   801047d0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d1f:	e8 8c 5c 00 00       	call   801069b0 <switchuvm>
  freevm(oldpgdir);
80100d24:	89 34 24             	mov    %esi,(%esp)
80100d27:	e8 e4 5f 00 00       	call   80106d10 <freevm>
  return 0;
...
80100d56:	c7 44 24 04 cd 70 10 	movl   $0x801070cd,0x4(%esp)
80100d5d:	80 
80100d5e:	c7 04 24 c0 ff 10 80 	movl   $0x8010ffc0,(%esp)
80100d65:	e8 56 36 00 00       	call   801043c0 <initlock>
}
80100d6a:	c9                   	leave  
80100d6b:	c3                   	ret    
...
80100d83:	e8 a8 37 00 00       	call   80104530 <acquire>
...
80100da9:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100db0:	e8 eb 37 00 00       	call   801045a0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dc7:	e8 d4 37 00 00       	call   801045a0 <release>
}
...
80100df1:	e8 3a 37 00 00       	call   80104530 <acquire>
  if(f->ref < 1)
...
80100e0a:	e8 91 37 00 00       	call   801045a0 <release>
  return f;
}
...
80100e16:	c3                   	ret    
    panic("filedup");
80100e17:	c7 04 24 d4 70 10 80 	movl   $0x801070d4,(%esp)
...
80100e43:	e8 e8 36 00 00       	call   80104530 <acquire>
  if(f->ref < 1)
...
80100e6a:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e6b:	e9 30 37 00 00       	jmp    801045a0 <release>
  ff = *f;
...
80100e8c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e8f:	e8 0c 37 00 00       	call   801045a0 <release>
  if(ff.type == FD_PIPE)
...
80100ed7:	e9 a4 1c 00 00       	jmp    80102b80 <end_op>
    panic("fileclose");
80100edc:	c7 04 24 dc 70 10 80 	movl   $0x801070dc,(%esp)
...
80100fc5:	eb d8                	jmp    80100f9f <fileread+0x5f>
  panic("fileread");
80100fc7:	c7 04 24 e6 70 10 80 	movl   $0x801070e6,(%esp)
...
801010dc:	e9 0f 22 00 00       	jmp    801032f0 <pipewrite>
        panic("short filewrite");
801010e1:	c7 04 24 ef 70 10 80 	movl   $0x801070ef,(%esp)
801010e8:	e8 73 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010ed:	c7 04 24 f5 70 10 80 	movl   $0x801070f5,(%esp)
...
80101164:	c3                   	ret    
    panic("freeing free block");
80101165:	c7 04 24 ff 70 10 80 	movl   $0x801070ff,(%esp)
...
80101225:	c7 04 24 12 71 10 80 	movl   $0x80107112,(%esp)
...
80101278:	e8 73 33 00 00       	call   801045f0 <memset>
  log_write(bp);
...
801012b9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
801012bc:	e8 6f 32 00 00       	call   80104530 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801012f6:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012f9:	e8 a2 32 00 00       	call   801045a0 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
8010133e:	e8 5d 32 00 00       	call   801045a0 <release>
}
...
8010134d:	c7 04 24 28 71 10 80 	movl   $0x80107128,(%esp)
...
80101405:	eb 93                	jmp    8010139a <bmap+0x3a>
  panic("bmap: out of range");
80101407:	c7 04 24 38 71 10 80 	movl   $0x80107138,(%esp)
...
80101452:	e8 39 32 00 00       	call   80104690 <memmove>
  brelse(bp);
...
8010147c:	c7 44 24 04 4b 71 10 	movl   $0x8010714b,0x4(%esp)
80101483:	80 
80101484:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010148b:	e8 30 2f 00 00       	call   801043c0 <initlock>
    initsleeplock(&icache.inode[i].lock, "inode");
80101490:	89 1c 24             	mov    %ebx,(%esp)
80101493:	81 c3 90 00 00 00    	add    $0x90,%ebx
80101499:	c7 44 24 04 52 71 10 	movl   $0x80107152,0x4(%esp)
801014a0:	80 
...
801014c6:	c7 04 24 b8 71 10 80 	movl   $0x801071b8,(%esp)
...
801015a9:	e8 42 30 00 00       	call   801045f0 <memset>
      dip->type = type;
...
801015e1:	c7 04 24 58 71 10 80 	movl   $0x80107158,(%esp)
...
8010165f:	00 
80101660:	e8 2b 30 00 00       	call   80104690 <memmove>
  log_write(bp);
...
80101691:	e8 9a 2e 00 00       	call   80104530 <acquire>
  ip->ref++;
80101696:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010169a:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016a1:	e8 fa 2e 00 00       	call   801045a0 <release>
}
...
8010174b:	e8 40 2f 00 00       	call   80104690 <memmove>
    brelse(bp);
...
80101764:	0f 85 76 ff ff ff    	jne    801016e0 <ilock+0x30>
      panic("ilock: no type");
8010176a:	c7 04 24 70 71 10 80 	movl   $0x80107170,(%esp)
80101771:	e8 ea eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101776:	c7 04 24 6a 71 10 80 	movl   $0x8010716a,(%esp)
...
801017a5:	e8 c6 2b 00 00       	call   80104370 <holdingsleep>
...
801017bd:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017be:	e9 6d 2b 00 00       	jmp    80104330 <releasesleep>
    panic("iunlock");
801017c3:	c7 04 24 7f 71 10 80 	movl   $0x8010717f,(%esp)
...
801017e2:	e8 e9 2a 00 00       	call   801042d0 <acquiresleep>
...
801017f8:	e8 33 2b 00 00       	call   80104330 <releasesleep>
  acquire(&icache.lock);
801017fd:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101804:	e8 27 2d 00 00       	call   80104530 <acquire>
  ip->ref--;
...
8010181a:	5d                   	pop    %ebp
  release(&icache.lock);
8010181b:	e9 80 2d 00 00       	jmp    801045a0 <release>
    acquire(&icache.lock);
80101820:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101827:	e8 04 2d 00 00       	call   80104530 <acquire>
    int r = ip->ref;
8010182c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010182f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101836:	e8 65 2d 00 00       	call   801045a0 <release>
    if(r == 1){
...
80101a08:	e8 83 2c 00 00       	call   80104690 <memmove>
    brelse(bp);
...
80101b04:	e8 87 2b 00 00       	call   80104690 <memmove>
    log_write(bp);
...
80101bab:	e8 60 2b 00 00       	call   80104710 <strncmp>
}
80101bb0:	c9                   	leave  
80101bb1:	c3                   	ret    
...
80101c29:	e8 e2 2a 00 00       	call   80104710 <strncmp>
      continue;
...
80101c61:	c3                   	ret    
      panic("dirlookup read");
80101c62:	c7 04 24 99 71 10 80 	movl   $0x80107199,(%esp)
80101c69:	e8 f2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c6e:	c7 04 24 87 71 10 80 	movl   $0x80107187,(%esp)
...
80101ca8:	e8 83 28 00 00       	call   80104530 <acquire>
  ip->ref++;
80101cad:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cb1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cb8:	e8 e3 28 00 00       	call   801045a0 <release>
...
80101d1b:	e8 70 29 00 00       	call   80104690 <memmove>
    path++;
...
80101da9:	e8 e2 28 00 00       	call   80104690 <memmove>
    name[len] = 0;
...
80101ea3:	e8 d8 28 00 00       	call   80104780 <strncpy>
  de.inum = inum;
...
80101ee3:	eb e9                	jmp    80101ece <dirlink+0xae>
      panic("dirlink read");
80101ee5:	c7 04 24 a8 71 10 80 	movl   $0x801071a8,(%esp)
...
80101fdf:	c7 04 24 14 72 10 80 	movl   $0x80107214,(%esp)
80101fe6:	e8 75 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
80101feb:	c7 04 24 0b 72 10 80 	movl   $0x8010720b,(%esp)
...
80102006:	c7 44 24 04 26 72 10 	movl   $0x80107226,0x4(%esp)
8010200d:	80 
8010200e:	c7 04 24 80 a5 10 80 	movl   $0x8010a580,(%esp)
80102015:	e8 a6 23 00 00       	call   801043c0 <initlock>
...
80102090:	e8 9b 24 00 00       	call   80104530 <acquire>
...
801020bc:	e8 7f 1d 00 00       	call   80103e40 <wakeup>
...
801020d6:	e8 c5 24 00 00       	call   801045a0 <release>
...
80102130:	e8 3b 22 00 00       	call   80104370 <holdingsleep>
...
80102166:	e8 c5 23 00 00       	call   80104530 <acquire>
...
801021c5:	5d                   	pop    %ebp
  release(&idelock);
801021c6:	e9 d5 23 00 00       	jmp    801045a0 <release>
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
801021d9:	eb bb                	jmp    80102196 <iderw+0x76>
    panic("iderw: buf not locked");
801021db:	c7 04 24 2a 72 10 80 	movl   $0x8010722a,(%esp)
801021e2:	e8 79 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
801021e7:	c7 04 24 55 72 10 80 	movl   $0x80107255,(%esp)
801021ee:	e8 6d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
801021f3:	c7 04 24 40 72 10 80 	movl   $0x80107240,(%esp)
...
80102248:	c7 04 24 74 72 10 80 	movl   $0x80107274,(%esp)
...
8010232a:	e8 c1 22 00 00       	call   801045f0 <memset>
...
80102363:	5d                   	pop    %ebp
    release(&kmem.lock);
80102364:	e9 37 22 00 00       	jmp    801045a0 <release>
80102369:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&kmem.lock);
80102370:	c7 04 24 40 26 11 80 	movl   $0x80112640,(%esp)
80102377:	e8 b4 21 00 00       	call   80104530 <acquire>
8010237c:	eb bb                	jmp    80102339 <kfree+0x49>
    panic("kfree");
8010237e:	c7 04 24 a6 72 10 80 	movl   $0x801072a6,(%esp)
...
801023eb:	c7 44 24 04 ac 72 10 	movl   $0x801072ac,0x4(%esp)
801023f2:	80 
801023f3:	c7 04 24 40 26 11 80 	movl   $0x80112640,(%esp)
801023fa:	e8 c1 1f 00 00       	call   801043c0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024cd:	e8 ce 20 00 00       	call   801045a0 <release>
  return (char*)r;
}
...
801024e7:	e8 44 20 00 00       	call   80104530 <acquire>
...
80102534:	0f b6 81 e0 73 10 80 	movzbl -0x7fef8c20(%ecx),%eax
...
80102568:	0f b6 91 e0 73 10 80 	movzbl -0x7fef8c20(%ecx),%edx
  shift ^= togglecode[data];
8010256f:	0f b6 81 e0 72 10 80 	movzbl -0x7fef8d20(%ecx),%eax
  shift |= shiftcode[data];
...
8010257f:	8b 04 85 c0 72 10 80 	mov    -0x7fef8d40(,%eax,4),%eax
  shift ^= togglecode[data];
...
8010289c:	e8 9f 1d 00 00       	call   80104640 <memcmp>
...
801029c7:	e8 c4 1c 00 00       	call   80104690 <memmove>
...
80102a7b:	c7 44 24 04 e0 74 10 	movl   $0x801074e0,0x4(%esp)
80102a82:	80 
80102a83:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102a8a:	e8 31 19 00 00       	call   801043c0 <initlock>
  readsb(dev, &sb);
...
80102b1d:	e8 0e 1a 00 00       	call   80104530 <acquire>
...
80102b65:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b6a:	e8 31 1a 00 00       	call   801045a0 <release>
      break;
    }
  }
}
...
80102b90:	e8 9b 19 00 00       	call   80104530 <acquire>
  log.outstanding -= 1;
...
80102bc8:	00 00 00 
  release(&log.lock);
80102bcb:	e8 d0 19 00 00       	call   801045a0 <release>
  if (log.lh.n > 0) {
...
80102c2f:	e8 5c 1a 00 00       	call   80104690 <memmove>
...
80102ca2:	c3                   	ret    
    panic("log.committing");
80102ca3:	c7 04 24 e4 74 10 80 	movl   $0x801074e4,(%esp)
...
80102ced:	e8 3e 18 00 00       	call   80104530 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d3e:	5d                   	pop    %ebp
  release(&log.lock);
80102d3f:	e9 5c 18 00 00       	jmp    801045a0 <release>
...
80102d5d:	8d 76 00             	lea    0x0(%esi),%esi
    panic("too big a transaction");
80102d60:	c7 04 24 f3 74 10 80 	movl   $0x801074f3,(%esp)
80102d67:	e8 f4 d5 ff ff       	call   80100360 <panic>
    panic("log_write outside of trans");
80102d6c:	c7 04 24 09 75 10 80 	movl   $0x80107509,(%esp)
...
80102d97:	c7 04 24 24 75 10 80 	movl   $0x80107524,(%esp)
80102d9e:	89 44 24 04          	mov    %eax,0x4(%esp)
80102da2:	e8 a9 d8 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80102da7:	e8 24 2b 00 00       	call   801058d0 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 b5 3b 00 00       	call   80106990 <switchkvm>
  seginit();
80102ddb:	e8 f0 3a 00 00       	call   801068d0 <seginit>
  lapicinit();
...
80102e13:	e8 08 40 00 00       	call   80106e20 <kvmalloc>
...
80102e25:	e8 a6 3a 00 00       	call   801068d0 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 b1 2d 00 00       	call   80105bf0 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 e6 29 00 00       	call   80105830 <tvinit>
  binit();         // buffer cache
...
80102e71:	e8 1a 18 00 00       	call   80104690 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f3f:	00 
80102f40:	c7 44 24 04 38 75 10 	movl   $0x80107538,0x4(%esp)
80102f47:	80 
80102f48:	89 34 24             	mov    %esi,(%esp)
80102f4b:	e8 f0 16 00 00       	call   80104640 <memcmp>
...
80102ffa:	00 
80102ffb:	c7 44 24 04 3d 75 10 	movl   $0x8010753d,0x4(%esp)
80103002:	80 
80103003:	89 04 24             	mov    %eax,(%esp)
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
80103006:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103009:	e8 32 16 00 00       	call   80104640 <memcmp>
...
8010308c:	ff 24 8d 7c 75 10 80 	jmp    *-0x7fef8a84(,%ecx,4)
80103093:	90                   	nop
...
80103117:	0f 85 c5 fe ff ff    	jne    80102fe2 <mpinit+0x52>
    panic("Expect to run on an SMP");
8010311d:	c7 04 24 42 75 10 80 	movl   $0x80107542,(%esp)
...
80103138:	eb e3                	jmp    8010311d <mpinit+0x18d>
    panic("Didn't find a suitable machine");
8010313a:	c7 04 24 5c 75 10 80 	movl   $0x8010755c,(%esp)
...
801031df:	c7 44 24 04 90 75 10 	movl   $0x80107590,0x4(%esp)
801031e6:	80 
801031e7:	e8 d4 11 00 00       	call   801043c0 <initlock>
  (*f0)->type = FD_PIPE;
...
80103271:	e8 ba 12 00 00       	call   80104530 <acquire>
  if(writable){
...
8010328d:	e8 ae 0b 00 00       	call   80103e40 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032ae:	5d                   	pop    %ebp
    release(&p->lock);
801032af:	e9 ec 12 00 00       	jmp    801045a0 <release>
...
801032ff:	e8 2c 12 00 00       	call   80104530 <acquire>
  for(i = 0; i < n; i++){
...
8010334f:	e8 ec 0a 00 00       	call   80103e40 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
80103382:	e8 19 12 00 00       	call   801045a0 <release>
        return -1;
...
801033ca:	e8 71 0a 00 00       	call   80103e40 <wakeup>
  release(&p->lock);
801033cf:	89 1c 24             	mov    %ebx,(%esp)
801033d2:	e8 c9 11 00 00       	call   801045a0 <release>
  return n;
...
801033f2:	e8 39 11 00 00       	call   80104530 <acquire>
...
8010344b:	e8 50 11 00 00       	call   801045a0 <release>
...
801034a5:	e8 96 09 00 00       	call   80103e40 <wakeup>
  release(&p->lock);
801034aa:	89 34 24             	mov    %esi,(%esp)
801034ad:	e8 ee 10 00 00       	call   801045a0 <release>
}
...
801034d3:	e8 58 10 00 00       	call   80104530 <acquire>
...
80103511:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103514:	e8 87 10 00 00       	call   801045a0 <release>
...
80103530:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103533:	c7 40 14 1f 58 10 80 	movl   $0x8010581f,0x14(%eax)
...
8010354d:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103550:	e8 9b 10 00 00       	call   801045f0 <memset>
...
8010356f:	e8 2c 10 00 00       	call   801045a0 <release>
}
...
8010359d:	e8 fe 0f 00 00       	call   801045a0 <release>
...
801035e6:	c7 44 24 04 95 75 10 	movl   $0x80107595,0x4(%esp)
801035ed:	80 
801035ee:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801035f5:	e8 c6 0d 00 00       	call   801043c0 <initlock>
}
801035fa:	c9                   	leave  
801035fb:	c3                   	ret    
...
8010365a:	c7 04 24 9c 75 10 80 	movl   $0x8010759c,(%esp)
80103661:	e8 fa cc ff ff       	call   80100360 <panic>
    panic("mycpu called with interrupts enabled\n");
80103666:	c7 04 24 78 76 10 80 	movl   $0x80107678,(%esp)
...
801036a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036a7:	e8 94 0d 00 00       	call   80104440 <pushcli>
  c = mycpu();
801036ac:	e8 4f ff ff ff       	call   80103600 <mycpu>
  p = c->proc;
801036b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036b7:	e8 c4 0d 00 00       	call   80104480 <popcli>
}
...
801036e3:	e8 a8 36 00 00       	call   80106d90 <setupkvm>
...
80103705:	80 
80103706:	e8 b5 33 00 00       	call   80106ac0 <inituvm>
  p->sz = PGSIZE;
...
80103727:	e8 c4 0e 00 00       	call   801045f0 <memset>
...
80103782:	00 
80103783:	c7 44 24 04 c5 75 10 	movl   $0x801075c5,0x4(%esp)
8010378a:	80 
8010378b:	89 04 24             	mov    %eax,(%esp)
8010378e:	e8 3d 10 00 00       	call   801047d0 <safestrcpy>
  p->cwd = namei("/");
80103793:	c7 04 24 ce 75 10 80 	movl   $0x801075ce,(%esp)
...
801037c7:	c7 04 24 ac 75 10 80 	movl   $0x801075ac,(%esp)
...
80103809:	e8 f2 33 00 00       	call   80106c00 <allocuvm>
...
80103817:	e8 94 31 00 00       	call   801069b0 <switchuvm>
  return 0;
...
8010383a:	e8 b1 34 00 00       	call   80106cf0 <deallocuvm>
...
8010387e:	e8 ed 35 00 00       	call   80106e70 <copyuvm>
...
801038a7:	31 f6                	xor    %esi,%esi
  np->priority_level=20;
801038a9:	c7 80 80 00 00 00 14 	movl   $0x14,0x80(%eax)
801038b0:	00 00 00 
  np->tf->eax = 0;
801038b3:	8b 40 18             	mov    0x18(%eax),%eax
...
80103985:	bf 54 2d 11 80       	mov    $0x80112d54,%edi
    acquire(&ptable.lock);
8010398a:	e8 a1 0b 00 00       	call   80104530 <acquire>
8010398f:	90                   	nop
      if(p->state != RUNNABLE){
80103990:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103994:	74 22                	je     801039b8 <scheduler+0x58>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103996:	81 c7 84 00 00 00    	add    $0x84,%edi
8010399c:	81 ff 54 4e 11 80    	cmp    $0x80114e54,%edi
801039a2:	72 ec                	jb     80103990 <scheduler+0x30>
    release(&ptable.lock);
801039a4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801039ab:	e8 f0 0b 00 00       	call   801045a0 <release>
  }
801039b0:	eb cb                	jmp    8010397d <scheduler+0x1d>
801039b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      for(nextP=p+1;nextP < &ptable.proc[NPROC];nextP++){
801039b8:	8d 87 84 00 00 00    	lea    0x84(%edi),%eax
801039be:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801039c3:	72 0f                	jb     801039d4 <scheduler+0x74>
801039c5:	eb 2e                	jmp    801039f5 <scheduler+0x95>
801039c7:	90                   	nop
801039c8:	05 84 00 00 00       	add    $0x84,%eax
801039cd:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801039d2:	73 21                	jae    801039f5 <scheduler+0x95>
	if(nextP->state==RUNNABLE && nextP->priority_level < p->priority_level)
801039d4:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
801039d8:	75 ee                	jne    801039c8 <scheduler+0x68>
801039da:	8b 8f 80 00 00 00    	mov    0x80(%edi),%ecx
801039e0:	39 88 80 00 00 00    	cmp    %ecx,0x80(%eax)
801039e6:	0f 4c f8             	cmovl  %eax,%edi
      for(nextP=p+1;nextP < &ptable.proc[NPROC];nextP++){
801039e9:	05 84 00 00 00       	add    $0x84,%eax
801039ee:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801039f3:	72 df                	jb     801039d4 <scheduler+0x74>
      c->proc = p;
801039f5:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
801039fb:	89 3c 24             	mov    %edi,(%esp)
801039fe:	e8 ad 2f 00 00       	call   801069b0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103a03:	8b 47 1c             	mov    0x1c(%edi),%eax
      p->state = RUNNING;
80103a06:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p->context);
80103a0d:	89 34 24             	mov    %esi,(%esp)
80103a10:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a14:	e8 12 0e 00 00       	call   8010482b <swtch>
      switchkvm();
80103a19:	e8 72 2f 00 00       	call   80106990 <switchkvm>
      for(nextP = ptable.proc; nextP<&ptable.proc[NPROC];nextP++){
80103a1e:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
      c->proc = 0;
80103a23:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103a2a:	00 00 00 
80103a2d:	eb 0f                	jmp    80103a3e <scheduler+0xde>
80103a2f:	90                   	nop
      for(nextP = ptable.proc; nextP<&ptable.proc[NPROC];nextP++){
80103a30:	81 c2 84 00 00 00    	add    $0x84,%edx
80103a36:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103a3c:	74 2a                	je     80103a68 <scheduler+0x108>
	if(nextP->state==RUNNABLE){
80103a3e:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
80103a42:	75 ec                	jne    80103a30 <scheduler+0xd0>
	  if(nextP == p && nextP -> priority_level <31){
80103a44:	39 fa                	cmp    %edi,%edx
80103a46:	8b 82 80 00 00 00    	mov    0x80(%edx),%eax
80103a4c:	74 2a                	je     80103a78 <scheduler+0x118>
	  else if(nextP != p && nextP->priority_level>0){
80103a4e:	85 c0                	test   %eax,%eax
80103a50:	7e de                	jle    80103a30 <scheduler+0xd0>
	    nextP->priority_level = nextP->priority_level - 1;
80103a52:	83 e8 01             	sub    $0x1,%eax
      for(nextP = ptable.proc; nextP<&ptable.proc[NPROC];nextP++){
80103a55:	81 c2 84 00 00 00    	add    $0x84,%edx
	    nextP->priority_level = nextP->priority_level - 1;
80103a5b:	89 42 fc             	mov    %eax,-0x4(%edx)
      for(nextP = ptable.proc; nextP<&ptable.proc[NPROC];nextP++){
80103a5e:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103a64:	75 d8                	jne    80103a3e <scheduler+0xde>
80103a66:	66 90                	xchg   %ax,%ax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a68:	bf d8 2d 11 80       	mov    $0x80112dd8,%edi
80103a6d:	e9 1e ff ff ff       	jmp    80103990 <scheduler+0x30>
80103a72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	  if(nextP == p && nextP -> priority_level <31){
80103a78:	83 f8 1e             	cmp    $0x1e,%eax
80103a7b:	7f b3                	jg     80103a30 <scheduler+0xd0>
	    nextP->priority_level= nextP->priority_level+1;
80103a7d:	83 c0 01             	add    $0x1,%eax
80103a80:	89 82 80 00 00 00    	mov    %eax,0x80(%edx)
80103a86:	eb a8                	jmp    80103a30 <scheduler+0xd0>
80103a88:	90                   	nop
...
80103aa4:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103aa6:	e8 45 0a 00 00       	call   801044f0 <holding>
...
80103ae7:	e8 3f 0d 00 00       	call   8010482b <swtch>
  mycpu()->intena = intena;
...
80103afe:	c7 04 24 d0 75 10 80 	movl   $0x801075d0,(%esp)
80103b05:	e8 56 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103b0a:	c7 04 24 fc 75 10 80 	movl   $0x801075fc,(%esp)
80103b11:	e8 4a c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103b16:	c7 04 24 ee 75 10 80 	movl   $0x801075ee,(%esp)
80103b1d:	e8 3e c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103b22:	c7 04 24 e2 75 10 80 	movl   $0x801075e2,(%esp)
...
80103b45:	89 c3                	mov    %eax,%ebx
  if(curproc == initproc)
80103b47:	0f 84 fd 00 00 00    	je     80103c4a <exit+0x11a>
...
80103b93:	e8 98 09 00 00       	call   80104530 <acquire>
...
80103ba8:	81 c2 84 00 00 00    	add    $0x84,%edx
80103bae:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
...
80103be2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103be8:	81 c1 84 00 00 00    	add    $0x84,%ecx
80103bee:	81 f9 54 4e 11 80    	cmp    $0x80114e54,%ecx
...
80103c0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c10:	81 c2 84 00 00 00    	add    $0x84,%edx
80103c16:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
...
80103c32:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103c39:	e8 52 fe ff ff       	call   80103a90 <sched>
  panic("zombie exit");
80103c3e:	c7 04 24 1d 76 10 80 	movl   $0x8010761d,(%esp)
80103c45:	e8 16 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103c4a:	c7 04 24 10 76 10 80 	movl   $0x80107610,(%esp)
...
80103c6d:	e8 be 08 00 00       	call   80104530 <acquire>
...
80103c8a:	e8 11 09 00 00       	call   801045a0 <release>
}
80103c8f:	c9                   	leave  
80103c90:	c3                   	ret    
...
80103cd1:	e8 5a 08 00 00       	call   80104530 <acquire>
    release(lk);
80103cd6:	89 34 24             	mov    %esi,(%esp)
80103cd9:	e8 c2 08 00 00       	call   801045a0 <release>
  p->chan = chan;
...
80103cfb:	e8 a0 08 00 00       	call   801045a0 <release>
    acquire(lk);
...
80103d09:	5d                   	pop    %ebp
    acquire(lk);
80103d0a:	e9 21 08 00 00       	jmp    80104530 <acquire>
80103d0f:	90                   	nop
  p->chan = chan;
...
80103d2e:	c7 04 24 2f 76 10 80 	movl   $0x8010762f,(%esp)
80103d35:	e8 26 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103d3a:	c7 04 24 29 76 10 80 	movl   $0x80107629,(%esp)
...
80103d68:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103d6a:	e8 c1 07 00 00       	call   80104530 <acquire>
    havekids = 0;
...
80103de0:	e8 2b 2f 00 00       	call   80106d10 <freevm>
	if(status){
...
80103e15:	e8 86 07 00 00       	call   801045a0 <release>
}
...
80103e2b:	e8 70 07 00 00       	call   801045a0 <release>
}
...
80103e51:	e8 da 06 00 00       	call   80104530 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e56:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103e5b:	eb 0f                	jmp    80103e6c <wakeup+0x2c>
80103e5d:	8d 76 00             	lea    0x0(%esi),%esi
80103e60:	05 84 00 00 00       	add    $0x84,%eax
80103e65:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103e6a:	74 24                	je     80103e90 <wakeup+0x50>
    if(p->state == SLEEPING && p->chan == chan)
80103e6c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103e70:	75 ee                	jne    80103e60 <wakeup+0x20>
80103e72:	3b 58 20             	cmp    0x20(%eax),%ebx
80103e75:	75 e9                	jne    80103e60 <wakeup+0x20>
      p->state = RUNNABLE;
80103e77:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e7e:	05 84 00 00 00       	add    $0x84,%eax
80103e83:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103e88:	75 e2                	jne    80103e6c <wakeup+0x2c>
80103e8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  wakeup1(chan);
  release(&ptable.lock);
80103e90:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80103e97:	83 c4 14             	add    $0x14,%esp
80103e9a:	5b                   	pop    %ebx
80103e9b:	5d                   	pop    %ebp
  release(&ptable.lock);
80103e9c:	e9 ff 06 00 00       	jmp    801045a0 <release>
80103ea1:	eb 0d                	jmp    80103eb0 <kill>
80103ea3:	90                   	nop
80103ea4:	90                   	nop
80103ea5:	90                   	nop
80103ea6:	90                   	nop
...
80103ec1:	e8 6a 06 00 00       	call   80104530 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ec6:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103ecb:	eb 0f                	jmp    80103edc <kill+0x2c>
80103ecd:	8d 76 00             	lea    0x0(%esi),%esi
80103ed0:	05 84 00 00 00       	add    $0x84,%eax
80103ed5:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103eda:	74 3c                	je     80103f18 <kill+0x68>
    if(p->pid == pid){
80103edc:	39 58 10             	cmp    %ebx,0x10(%eax)
80103edf:	75 ef                	jne    80103ed0 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80103ee1:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
80103ee5:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
80103eec:	74 1a                	je     80103f08 <kill+0x58>
        p->state = RUNNABLE;
      release(&ptable.lock);
80103eee:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ef5:	e8 a6 06 00 00       	call   801045a0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103efa:	83 c4 14             	add    $0x14,%esp
      return 0;
...
80103f41:	eb 23                	jmp    80103f66 <procdump+0x36>
80103f43:	90                   	nop
80103f44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f48:	c7 04 24 c3 79 10 80 	movl   $0x801079c3,(%esp)
80103f4f:	e8 fc c6 ff ff       	call   80100650 <cprintf>
80103f54:	81 c3 84 00 00 00    	add    $0x84,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f5a:	81 fb c0 4e 11 80    	cmp    $0x80114ec0,%ebx
80103f60:	0f 84 8a 00 00 00    	je     80103ff0 <procdump+0xc0>
    if(p->state == UNUSED)
80103f66:	8b 43 a0             	mov    -0x60(%ebx),%eax
80103f69:	85 c0                	test   %eax,%eax
80103f6b:	74 e7                	je     80103f54 <procdump+0x24>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f6d:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103f70:	ba 40 76 10 80       	mov    $0x80107640,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f75:	77 11                	ja     80103f88 <procdump+0x58>
80103f77:	8b 14 85 a0 76 10 80 	mov    -0x7fef8960(,%eax,4),%edx
      state = "???";
80103f7e:	b8 40 76 10 80       	mov    $0x80107640,%eax
80103f83:	85 d2                	test   %edx,%edx
80103f85:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80103f88:	8b 43 a4             	mov    -0x5c(%ebx),%eax
80103f8b:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80103f8f:	89 54 24 08          	mov    %edx,0x8(%esp)
80103f93:	c7 04 24 44 76 10 80 	movl   $0x80107644,(%esp)
80103f9a:	89 44 24 04          	mov    %eax,0x4(%esp)
80103f9e:	e8 ad c6 ff ff       	call   80100650 <cprintf>
    if(p->state == SLEEPING){
80103fa3:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
80103fa7:	75 9f                	jne    80103f48 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80103fa9:	8d 45 c0             	lea    -0x40(%ebp),%eax
80103fac:	89 44 24 04          	mov    %eax,0x4(%esp)
80103fb0:	8b 43 b0             	mov    -0x50(%ebx),%eax
80103fb3:	8d 7d c0             	lea    -0x40(%ebp),%edi
80103fb6:	8b 40 0c             	mov    0xc(%eax),%eax
80103fb9:	83 c0 08             	add    $0x8,%eax
80103fbc:	89 04 24             	mov    %eax,(%esp)
80103fbf:	e8 1c 04 00 00       	call   801043e0 <getcallerpcs>
...
80103fd9:	c7 04 24 81 70 10 80 	movl   $0x80107081,(%esp)
...
80104003:	56                   	push   %esi
  ...
  if(curproc == initproc)
80104004:	31 f6                	xor    %esi,%esi
{
80104006:	53                   	push   %ebx
80104007:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
8010400a:	e8 91 f6 ff ff       	call   801036a0 <myproc>
  if(curproc == initproc)
8010400f:	3b 05 b8 a5 10 80    	cmp    0x8010a5b8,%eax
  struct proc *curproc = myproc();
80104015:	89 c3                	mov    %eax,%ebx
  if(curproc == initproc)
80104017:	0f 84 03 01 00 00    	je     80104120 <exitS+0x120>
...
80104026:	74 10                	je     80104038 <exitS+0x38>
      fileclose(curproc->ofile[fd]);
80104028:	89 04 24             	mov    %eax,(%esp)
8010402b:	e8 00 ce ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
80104030:	c7 44 b3 28 00 00 00 	movl   $0x0,0x28(%ebx,%esi,4)
80104037:	00 
  for(fd = 0; fd < NOFILE; fd++){
80104038:	83 c6 01             	add    $0x1,%esi
8010403b:	83 fe 10             	cmp    $0x10,%esi
8010403e:	75 e0                	jne    80104020 <exitS+0x20>
    }
  }

  begin_op();
80104040:	e8 cb ea ff ff       	call   80102b10 <begin_op>
  iput(curproc->cwd);
80104045:	8b 43 68             	mov    0x68(%ebx),%eax
80104048:	89 04 24             	mov    %eax,(%esp)
8010404b:	e8 80 d7 ff ff       	call   801017d0 <iput>
  end_op();
80104050:	e8 2b eb ff ff       	call   80102b80 <end_op>
  curproc->cwd = 0;
80104055:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)

  acquire(&ptable.lock);
8010405c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104063:	e8 c8 04 00 00       	call   80104530 <acquire>


  wakeup1(curproc->parent);
80104068:	8b 43 14             	mov    0x14(%ebx),%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010406b:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80104070:	eb 14                	jmp    80104086 <exitS+0x86>
80104072:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104078:	81 c2 84 00 00 00    	add    $0x84,%edx
8010407e:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80104084:	74 20                	je     801040a6 <exitS+0xa6>
    if(p->state == SLEEPING && p->chan == chan)
80104086:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
8010408a:	75 ec                	jne    80104078 <exitS+0x78>
8010408c:	3b 42 20             	cmp    0x20(%edx),%eax
8010408f:	75 e7                	jne    80104078 <exitS+0x78>
      p->state = RUNNABLE;
80104091:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104098:	81 c2 84 00 00 00    	add    $0x84,%edx
8010409e:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
801040a4:	75 e0                	jne    80104086 <exitS+0x86>

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
801040a6:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
801040ab:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
801040b0:	eb 14                	jmp    801040c6 <exitS+0xc6>
801040b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040b8:	81 c1 84 00 00 00    	add    $0x84,%ecx
801040be:	81 f9 54 4e 11 80    	cmp    $0x80114e54,%ecx
801040c4:	74 3c                	je     80104102 <exitS+0x102>
    if(p->parent == curproc){
801040c6:	39 59 14             	cmp    %ebx,0x14(%ecx)
801040c9:	75 ed                	jne    801040b8 <exitS+0xb8>
      if(p->state == ZOMBIE)
801040cb:	83 79 0c 05          	cmpl   $0x5,0xc(%ecx)
      p->parent = initproc;
801040cf:	89 41 14             	mov    %eax,0x14(%ecx)
      if(p->state == ZOMBIE)
801040d2:	75 e4                	jne    801040b8 <exitS+0xb8>
801040d4:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
801040d9:	eb 13                	jmp    801040ee <exitS+0xee>
801040db:	90                   	nop
801040dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040e0:	81 c2 84 00 00 00    	add    $0x84,%edx
801040e6:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
801040ec:	74 ca                	je     801040b8 <exitS+0xb8>
    if(p->state == SLEEPING && p->chan == chan)
801040ee:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
801040f2:	75 ec                	jne    801040e0 <exitS+0xe0>
801040f4:	3b 42 20             	cmp    0x20(%edx),%eax
801040f7:	75 e7                	jne    801040e0 <exitS+0xe0>
      p->state = RUNNABLE;
801040f9:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
80104100:	eb de                	jmp    801040e0 <exitS+0xe0>
        wakeup1(initproc);
    }
  }
...
80104102:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  curproc->state = ZOMBIE;
80104105:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  curproc->exit_status = status;
8010410c:	89 43 7c             	mov    %eax,0x7c(%ebx)
  sched();
8010410f:	e8 7c f9 ff ff       	call   80103a90 <sched>
  panic("zombie exit");
80104114:	c7 04 24 1d 76 10 80 	movl   $0x8010761d,(%esp)
8010411b:	e8 40 c2 ff ff       	call   80100360 <panic>
    panic("init exiting");
80104120:	c7 04 24 10 76 10 80 	movl   $0x80107610,(%esp)
80104127:	e8 34 c2 ff ff       	call   80100360 <panic>
...
80104139:	8b 75 08             	mov    0x8(%ebp),%esi
  struct proc *p;
  int havekids, pid2;
  struct proc *curproc = myproc();
8010413c:	e8 5f f5 ff ff       	call   801036a0 <myproc>

  acquire(&ptable.lock);
80104141:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80104148:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  acquire(&ptable.lock);
8010414b:	e8 e0 03 00 00       	call   80104530 <acquire>
  for(;;){
	havekids = 0;
80104150:	31 c9                	xor    %ecx,%ecx
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104152:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80104157:	eb 15                	jmp    8010416e <waitpid+0x3e>
...
8010416c:	74 20                	je     8010418e <waitpid+0x5e>
          if(p->pid != pid)
8010416e:	8b 7b 10             	mov    0x10(%ebx),%edi
80104171:	39 f7                	cmp    %esi,%edi
80104173:	75 eb                	jne    80104160 <waitpid+0x30>
            continue;
        havekids = 1;
        if(p->state == ZOMBIE){
80104175:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104179:	74 3d                	je     801041b8 <waitpid+0x88>
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010417b:	81 c3 84 00 00 00    	add    $0x84,%ebx
        havekids = 1;
80104181:	b9 01 00 00 00       	mov    $0x1,%ecx
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104186:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
8010418c:	75 e0                	jne    8010416e <waitpid+0x3e>
    ...
    if(!havekids || curproc->killed){
8010418e:	85 c9                	test   %ecx,%ecx
80104190:	0f 84 84 00 00 00    	je     8010421a <waitpid+0xea>
80104196:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104199:	8b 40 24             	mov    0x24(%eax),%eax
8010419c:	85 c0                	test   %eax,%eax
8010419e:	75 7a                	jne    8010421a <waitpid+0xea>
      release(&ptable.lock);
      return -1;
    }
    sleep(curproc, &ptable.lock);
801041a0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801041a3:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
801041aa:	80 
801041ab:	89 04 24             	mov    %eax,(%esp)
801041ae:	e8 ed fa ff ff       	call   80103ca0 <sleep>
    }
801041b3:	eb 9b                	jmp    80104150 <waitpid+0x20>
801041b5:	8d 76 00             	lea    0x0(%esi),%esi
          kfree(p->kstack);
801041b8:	8b 53 08             	mov    0x8(%ebx),%edx
801041bb:	89 14 24             	mov    %edx,(%esp)
801041be:	e8 2d e1 ff ff       	call   801022f0 <kfree>
          freevm(p->pgdir);
801041c3:	8b 53 04             	mov    0x4(%ebx),%edx
          p->kstack = 0;
801041c6:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
          freevm(p->pgdir);
801041cd:	89 14 24             	mov    %edx,(%esp)
801041d0:	e8 3b 2b 00 00       	call   80106d10 <freevm>
          if(status){
801041d5:	8b 55 0c             	mov    0xc(%ebp),%edx
          p->pid = 0;
801041d8:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
          p->parent = 0;
801041df:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
          p->name[0] = 0;
801041e6:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
          if(status){
801041ea:	85 d2                	test   %edx,%edx
          p->killed = 0;
801041ec:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
          p->state = UNUSED;
801041f3:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
          if(status){
801041fa:	74 08                	je     80104204 <waitpid+0xd4>
            *status = p->exit_status;
801041fc:	8b 53 7c             	mov    0x7c(%ebx),%edx
801041ff:	8b 45 0c             	mov    0xc(%ebp),%eax
80104202:	89 10                	mov    %edx,(%eax)
          release(&ptable.lock);
80104204:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010420b:	e8 90 03 00 00       	call   801045a0 <release>
}
80104210:	83 c4 1c             	add    $0x1c,%esp
...
80104219:	c3                   	ret    
      release(&ptable.lock);
8010421a:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
      return -1;
80104221:	bf ff ff ff ff       	mov    $0xffffffff,%edi
      release(&ptable.lock);
80104226:	e8 75 03 00 00       	call   801045a0 <release>
      return -1;
8010422b:	eb e3                	jmp    80104210 <waitpid+0xe0>
...
80104238:	8b 5d 08             	mov    0x8(%ebp),%ebx
    struct proc *p;
    p = myproc();
8010423b:	e8 60 f4 ff ff       	call   801036a0 <myproc>
    if(prior_lvl<0)
80104240:	85 db                	test   %ebx,%ebx
    p = myproc();
80104242:	89 c6                	mov    %eax,%esi
    if(prior_lvl<0)
80104244:	78 3a                	js     80104280 <set_prior+0x50>
	prior_lvl=0;
    if(prior_lvl>31)
	prior_lvl=31;
80104246:	83 fb 20             	cmp    $0x20,%ebx
80104249:	b8 1f 00 00 00       	mov    $0x1f,%eax
8010424e:	0f 4d d8             	cmovge %eax,%ebx
    acquire(&ptable.lock);
80104251:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104258:	e8 d3 02 00 00       	call   80104530 <acquire>
    p->priority_level = prior_lvl;
8010425d:	89 9e 80 00 00 00    	mov    %ebx,0x80(%esi)
    release(&ptable.lock);
80104263:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010426a:	e8 31 03 00 00       	call   801045a0 <release>
    yield();
8010426f:	e8 ec f9 ff ff       	call   80103c60 <yield>
    return 0;
}
...
80104282:	eb cd                	jmp    80104251 <set_prior+0x21>
...
8010429a:	c7 44 24 04 b8 76 10 	movl   $0x801076b8,0x4(%esp)
801042a1:	80 
801042a2:	8d 43 04             	lea    0x4(%ebx),%eax
801042a5:	89 04 24             	mov    %eax,(%esp)
801042a8:	e8 13 01 00 00       	call   801043c0 <initlock>
  lk->name = name;
...
801042e1:	e8 4a 02 00 00       	call   80104530 <acquire>
  while (lk->locked) {
...
801042f7:	e8 a4 f9 ff ff       	call   80103ca0 <sleep>
  while (lk->locked) {
...
80104302:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104308:	e8 93 f3 ff ff       	call   801036a0 <myproc>
8010430d:	8b 40 10             	mov    0x10(%eax),%eax
80104310:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80104313:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
8010431b:	5d                   	pop    %ebp
  release(&lk->lk);
8010431c:	e9 7f 02 00 00       	jmp    801045a0 <release>
80104321:	eb 0d                	jmp    80104330 <releasesleep>
80104323:	90                   	nop
80104324:	90                   	nop
80104325:	90                   	nop
80104326:	90                   	nop
...
80104341:	e8 ea 01 00 00       	call   80104530 <acquire>
  lk->locked = 0;
...
80104356:	e8 e5 fa ff ff       	call   80103e40 <wakeup>
  release(&lk->lk);
...
80104363:	5d                   	pop    %ebp
  release(&lk->lk);
80104364:	e9 37 02 00 00       	jmp    801045a0 <release>
...
80104378:	83 ec 1c             	sub    $0x1c,%esp
8010437b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
8010437e:	8d 73 04             	lea    0x4(%ebx),%esi
80104381:	89 34 24             	mov    %esi,(%esp)
80104384:	e8 a7 01 00 00       	call   80104530 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104389:	8b 03                	mov    (%ebx),%eax
8010438b:	85 c0                	test   %eax,%eax
8010438d:	74 13                	je     801043a2 <holdingsleep+0x32>
8010438f:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80104392:	e8 09 f3 ff ff       	call   801036a0 <myproc>
80104397:	3b 58 10             	cmp    0x10(%eax),%ebx
8010439a:	0f 94 c0             	sete   %al
8010439d:	0f b6 c0             	movzbl %al,%eax
801043a0:	89 c7                	mov    %eax,%edi
  release(&lk->lk);
801043a2:	89 34 24             	mov    %esi,(%esp)
801043a5:	e8 f6 01 00 00       	call   801045a0 <release>
  return r;
}
801043aa:	83 c4 1c             	add    $0x1c,%esp
801043ad:	89 f8                	mov    %edi,%eax
801043af:	5b                   	pop    %ebx
801043b0:	5e                   	pop    %esi
801043b1:	5f                   	pop    %edi
801043b2:	5d                   	pop    %ebp
801043b3:	c3                   	ret    
801043b4:	66 90                	xchg   %ax,%ax
...
80104449:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010444a:	e8 b1 f1 ff ff       	call   80103600 <mycpu>
8010444f:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104455:	85 c0                	test   %eax,%eax
80104457:	75 11                	jne    8010446a <pushcli+0x2a>
    mycpu()->intena = eflags & FL_IF;
80104459:	e8 a2 f1 ff ff       	call   80103600 <mycpu>
8010445e:	81 e3 00 02 00 00    	and    $0x200,%ebx
80104464:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010446a:	e8 91 f1 ff ff       	call   80103600 <mycpu>
8010446f:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
80104476:	83 c4 04             	add    $0x4,%esp
80104479:	5b                   	pop    %ebx
8010447a:	5d                   	pop    %ebp
8010447b:	c3                   	ret    
...
8010448b:	75 49                	jne    801044d6 <popcli+0x56>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
8010448d:	e8 6e f1 ff ff       	call   80103600 <mycpu>
80104492:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
80104498:	8d 51 ff             	lea    -0x1(%ecx),%edx
8010449b:	85 d2                	test   %edx,%edx
8010449d:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
801044a3:	78 25                	js     801044ca <popcli+0x4a>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044a5:	e8 56 f1 ff ff       	call   80103600 <mycpu>
801044aa:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
801044b0:	85 d2                	test   %edx,%edx
801044b2:	74 04                	je     801044b8 <popcli+0x38>
    sti();
}
801044b4:	c9                   	leave  
801044b5:	c3                   	ret    
801044b6:	66 90                	xchg   %ax,%ax
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044b8:	e8 43 f1 ff ff       	call   80103600 <mycpu>
801044bd:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
801044c3:	85 c0                	test   %eax,%eax
801044c5:	74 ed                	je     801044b4 <popcli+0x34>
  asm volatile("sti");
801044c7:	fb                   	sti    
}
801044c8:	c9                   	leave  
801044c9:	c3                   	ret    
    panic("popcli");
801044ca:	c7 04 24 da 76 10 80 	movl   $0x801076da,(%esp)
801044d1:	e8 8a be ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
801044d6:	c7 04 24 c3 76 10 80 	movl   $0x801076c3,(%esp)
801044dd:	e8 7e be ff ff       	call   80100360 <panic>
...
801044f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801044fa:	e8 41 ff ff ff       	call   80104440 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801044ff:	8b 03                	mov    (%ebx),%eax
80104501:	85 c0                	test   %eax,%eax
80104503:	74 12                	je     80104517 <holding+0x27>
80104505:	8b 5b 08             	mov    0x8(%ebx),%ebx
80104508:	e8 f3 f0 ff ff       	call   80103600 <mycpu>
8010450d:	39 c3                	cmp    %eax,%ebx
8010450f:	0f 94 c0             	sete   %al
80104512:	0f b6 c0             	movzbl %al,%eax
80104515:	89 c6                	mov    %eax,%esi
  popcli();
80104517:	e8 64 ff ff ff       	call   80104480 <popcli>
}
...
80104537:	e8 04 ff ff ff       	call   80104440 <pushcli>
  if(holding(lk))
8010453c:	8b 45 08             	mov    0x8(%ebp),%eax
8010453f:	89 04 24             	mov    %eax,(%esp)
80104542:	e8 a9 ff ff ff       	call   801044f0 <holding>
80104547:	85 c0                	test   %eax,%eax
80104549:	75 3a                	jne    80104585 <acquire+0x55>
  asm volatile("lock; xchgl %0, %1" :
8010454b:	b9 01 00 00 00       	mov    $0x1,%ecx
  while(xchg(&lk->locked, 1) != 0)
80104550:	8b 55 08             	mov    0x8(%ebp),%edx
80104553:	89 c8                	mov    %ecx,%eax
80104555:	f0 87 02             	lock xchg %eax,(%edx)
80104558:	85 c0                	test   %eax,%eax
8010455a:	75 f4                	jne    80104550 <acquire+0x20>
  __sync_synchronize();
8010455c:	0f ae f0             	mfence 
  lk->cpu = mycpu();
8010455f:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104562:	e8 99 f0 ff ff       	call   80103600 <mycpu>
80104567:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
8010456a:	8b 45 08             	mov    0x8(%ebp),%eax
8010456d:	83 c0 0c             	add    $0xc,%eax
80104570:	89 44 24 04          	mov    %eax,0x4(%esp)
80104574:	8d 45 08             	lea    0x8(%ebp),%eax
80104577:	89 04 24             	mov    %eax,(%esp)
8010457a:	e8 61 fe ff ff       	call   801043e0 <getcallerpcs>
}
8010457f:	83 c4 14             	add    $0x14,%esp
80104582:	5b                   	pop    %ebx
80104583:	5d                   	pop    %ebp
80104584:	c3                   	ret    
    panic("acquire");
80104585:	c7 04 24 e1 76 10 80 	movl   $0x801076e1,(%esp)
8010458c:	e8 cf bd ff ff       	call   80100360 <panic>
...
801045a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!holding(lk))
801045aa:	89 1c 24             	mov    %ebx,(%esp)
801045ad:	e8 3e ff ff ff       	call   801044f0 <holding>
801045b2:	85 c0                	test   %eax,%eax
801045b4:	74 21                	je     801045d7 <release+0x37>
  lk->pcs[0] = 0;
801045b6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
801045bd:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
801045c4:	0f ae f0             	mfence 
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
801045c7:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
801045cd:	83 c4 14             	add    $0x14,%esp
801045d0:	5b                   	pop    %ebx
801045d1:	5d                   	pop    %ebp
  popcli();
801045d2:	e9 a9 fe ff ff       	jmp    80104480 <popcli>
    panic("release");
801045d7:	c7 04 24 e9 76 10 80 	movl   $0x801076e9,(%esp)
801045de:	e8 7d bd ff ff       	call   80100360 <panic>
801045e3:	66 90                	xchg   %ax,%ax
801045e5:	66 90                	xchg   %ax,%ax
...
80104643:	8b 45 10             	mov    0x10(%ebp),%eax
...
80104651:	8d 78 ff             	lea    -0x1(%eax),%edi
80104654:	74 26                	je     8010467c <memcmp+0x3c>
    if(*s1 != *s2)
80104656:	0f b6 03             	movzbl (%ebx),%eax
80104659:	31 d2                	xor    %edx,%edx
8010465b:	0f b6 0e             	movzbl (%esi),%ecx
8010465e:	38 c8                	cmp    %cl,%al
80104660:	74 16                	je     80104678 <memcmp+0x38>
80104662:	eb 24                	jmp    80104688 <memcmp+0x48>
80104664:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104668:	0f b6 44 13 01       	movzbl 0x1(%ebx,%edx,1),%eax
8010466d:	83 c2 01             	add    $0x1,%edx
80104670:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
80104674:	38 c8                	cmp    %cl,%al
80104676:	75 10                	jne    80104688 <memcmp+0x48>
  while(n-- > 0){
80104678:	39 fa                	cmp    %edi,%edx
...
8010469c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
8010469f:	39 c6                	cmp    %eax,%esi
801046a1:	73 35                	jae    801046d8 <memmove+0x48>
801046a3:	8d 0c 1e             	lea    (%esi,%ebx,1),%ecx
801046a6:	39 c8                	cmp    %ecx,%eax
801046a8:	73 2e                	jae    801046d8 <memmove+0x48>
    s += n;
    d += n;
    while(n-- > 0)
801046aa:	85 db                	test   %ebx,%ebx
    d += n;
801046ac:	8d 3c 18             	lea    (%eax,%ebx,1),%edi
    while(n-- > 0)
801046af:	8d 53 ff             	lea    -0x1(%ebx),%edx
801046b2:	74 1b                	je     801046cf <memmove+0x3f>
801046b4:	f7 db                	neg    %ebx
801046b6:	8d 34 19             	lea    (%ecx,%ebx,1),%esi
801046b9:	01 fb                	add    %edi,%ebx
801046bb:	90                   	nop
801046bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *--d = *--s;
801046c0:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
801046c4:	88 0c 13             	mov    %cl,(%ebx,%edx,1)
    while(n-- > 0)
801046c7:	83 ea 01             	sub    $0x1,%edx
801046ca:	83 fa ff             	cmp    $0xffffffff,%edx
801046cd:	75 f1                	jne    801046c0 <memmove+0x30>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
801046dc:	74 f1                	je     801046cf <memmove+0x3f>
...
80104718:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010471b:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  while(n > 0 && *p && *p == *q)
8010471e:	85 f6                	test   %esi,%esi
80104720:	74 30                	je     80104752 <strncmp+0x42>
80104722:	0f b6 01             	movzbl (%ecx),%eax
80104725:	84 c0                	test   %al,%al
80104727:	74 2f                	je     80104758 <strncmp+0x48>
80104729:	0f b6 13             	movzbl (%ebx),%edx
8010472c:	38 d0                	cmp    %dl,%al
8010472e:	75 46                	jne    80104776 <strncmp+0x66>
80104730:	8d 51 01             	lea    0x1(%ecx),%edx
80104733:	01 ce                	add    %ecx,%esi
80104735:	eb 14                	jmp    8010474b <strncmp+0x3b>
80104737:	90                   	nop
80104738:	0f b6 02             	movzbl (%edx),%eax
8010473b:	84 c0                	test   %al,%al
8010473d:	74 31                	je     80104770 <strncmp+0x60>
8010473f:	0f b6 19             	movzbl (%ecx),%ebx
80104742:	83 c2 01             	add    $0x1,%edx
80104745:	38 d8                	cmp    %bl,%al
80104747:	75 17                	jne    80104760 <strncmp+0x50>
    n--, p++, q++;
80104749:	89 cb                	mov    %ecx,%ebx
  while(n > 0 && *p && *p == *q)
8010474b:	39 f2                	cmp    %esi,%edx
    n--, p++, q++;
8010474d:	8d 4b 01             	lea    0x1(%ebx),%ecx
  while(n > 0 && *p && *p == *q)
...
80104756:	5d                   	pop    %ebp
80104757:	c3                   	ret    
80104758:	0f b6 1b             	movzbl (%ebx),%ebx
  while(n > 0 && *p && *p == *q)
8010475b:	31 c0                	xor    %eax,%eax
8010475d:	8d 76 00             	lea    0x0(%esi),%esi
  return (uchar)*p - (uchar)*q;
80104760:	0f b6 d3             	movzbl %bl,%edx
80104763:	29 d0                	sub    %edx,%eax
}
80104765:	5b                   	pop    %ebx
80104766:	5e                   	pop    %esi
80104767:	5d                   	pop    %ebp
...
80104770:	0f b6 5b 01          	movzbl 0x1(%ebx),%ebx
80104774:	eb ea                	jmp    80104760 <strncmp+0x50>
  while(n > 0 && *p && *p == *q)
80104776:	89 d3                	mov    %edx,%ebx
80104778:	eb e6                	jmp    80104760 <strncmp+0x50>
...
801047b6:	7e 0f                	jle    801047c7 <strncpy+0x47>
    *s++ = 0;
801047b8:	c6 04 0a 00          	movb   $0x0,(%edx,%ecx,1)
801047bc:	89 f3                	mov    %esi,%ebx
801047be:	83 c1 01             	add    $0x1,%ecx
801047c1:	29 cb                	sub    %ecx,%ebx
  while(n-- > 0)
801047c3:	85 db                	test   %ebx,%ebx
801047c5:	7f f1                	jg     801047b8 <strncpy+0x38>
  return os;
}
801047c7:	5b                   	pop    %ebx
801047c8:	5e                   	pop    %esi
...
801047d3:	8b 4d 10             	mov    0x10(%ebp),%ecx
...
80104887:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010488a:	e8 11 ee ff ff       	call   801036a0 <myproc>

  if(addr >= curproc->sz)
8010488f:	39 18                	cmp    %ebx,(%eax)
80104891:	76 26                	jbe    801048b9 <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
...
8010489e:	73 19                	jae    801048b9 <fetchstr+0x39>
    if(*s == 0)
801048a0:	80 3b 00             	cmpb   $0x0,(%ebx)
801048a3:	75 0d                	jne    801048b2 <fetchstr+0x32>
801048a5:	eb 21                	jmp    801048c8 <fetchstr+0x48>
801048a7:	90                   	nop
801048a8:	80 3a 00             	cmpb   $0x0,(%edx)
801048ab:	90                   	nop
801048ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801048b0:	74 16                	je     801048c8 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
801048b2:	83 c2 01             	add    $0x1,%edx
801048b5:	39 d0                	cmp    %edx,%eax
801048b7:	77 ef                	ja     801048a8 <fetchstr+0x28>
      return s - *pp;
  }
  return -1;
}
...
801048c8:	83 c4 04             	add    $0x4,%esp
      return s - *pp;
801048cb:	89 d0                	mov    %edx,%eax
801048cd:	29 d8                	sub    %ebx,%eax
}
801048cf:	5b                   	pop    %ebx
801048d0:	5d                   	pop    %ebp
801048d1:	c3                   	ret    
...
801048e4:	8b 75 0c             	mov    0xc(%ebp),%esi
801048e7:	53                   	push   %ebx
801048e8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801048eb:	e8 b0 ed ff ff       	call   801036a0 <myproc>
801048f0:	89 75 0c             	mov    %esi,0xc(%ebp)
801048f3:	8b 40 18             	mov    0x18(%eax),%eax
801048f6:	8b 40 44             	mov    0x44(%eax),%eax
801048f9:	8d 44 98 04          	lea    0x4(%eax,%ebx,4),%eax
801048fd:	89 45 08             	mov    %eax,0x8(%ebp)
}
80104900:	5b                   	pop    %ebx
80104901:	5e                   	pop    %esi
80104902:	5d                   	pop    %ebp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104903:	e9 38 ff ff ff       	jmp    80104840 <fetchint>
80104908:	90                   	nop
...
80104943:	73 1b                	jae    80104960 <argptr+0x50>
80104945:	01 d3                	add    %edx,%ebx
80104947:	39 d8                	cmp    %ebx,%eax
80104949:	72 15                	jb     80104960 <argptr+0x50>
    return -1;
  *pp = (char*)i;
8010494b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010494e:	89 10                	mov    %edx,(%eax)
  return 0;
}
80104950:	83 c4 20             	add    $0x20,%esp
  return 0;
...
80104960:	83 c4 20             	add    $0x20,%esp
    return -1;
...
80104983:	e8 58 ff ff ff       	call   801048e0 <argint>
80104988:	85 c0                	test   %eax,%eax
8010498a:	78 14                	js     801049a0 <argstr+0x30>
    return -1;
...
80104999:	e8 e2 fe ff ff       	call   80104880 <fetchstr>
}
8010499e:	c9                   	leave  
8010499f:	c3                   	ret    
    return -1;
...
801049b5:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
801049b8:	e8 e3 ec ff ff       	call   801036a0 <myproc>

  num = curproc->tf->eax;
801049bd:	8b 70 18             	mov    0x18(%eax),%esi
  struct proc *curproc = myproc();
801049c0:	89 c3                	mov    %eax,%ebx
  num = curproc->tf->eax;
801049c2:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801049c5:	8d 50 ff             	lea    -0x1(%eax),%edx
801049c8:	83 fa 17             	cmp    $0x17,%edx
801049cb:	77 1b                	ja     801049e8 <syscall+0x38>
801049cd:	8b 14 85 20 77 10 80 	mov    -0x7fef88e0(,%eax,4),%edx
801049d4:	85 d2                	test   %edx,%edx
801049d6:	74 10                	je     801049e8 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
801049d8:	ff d2                	call   *%edx
801049da:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
801049e8:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
801049ec:	8d 43 6c             	lea    0x6c(%ebx),%eax
801049ef:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
801049f3:	8b 43 10             	mov    0x10(%ebx),%eax
801049f6:	c7 04 24 f1 76 10 80 	movl   $0x801076f1,(%esp)
801049fd:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a01:	e8 4a bc ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
80104a06:	8b 43 18             	mov    0x18(%ebx),%eax
80104a09:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
80104a69:	89 4d d0             	mov    %ecx,-0x30(%ebp)
80104a6c:	8b 4d 08             	mov    0x8(%ebp),%ecx
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80104a6f:	8d 5d da             	lea    -0x26(%ebp),%ebx
80104a72:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104a76:	89 04 24             	mov    %eax,(%esp)
{
80104a79:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104a7c:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104a7f:	e8 9c d4 ff ff       	call   80101f20 <nameiparent>
80104a84:	85 c0                	test   %eax,%eax
80104a86:	89 c7                	mov    %eax,%edi
80104a88:	0f 84 da 00 00 00    	je     80104b68 <create+0x108>
    return 0;
  ilock(dp);
80104a8e:	89 04 24             	mov    %eax,(%esp)
80104a91:	e8 1a cc ff ff       	call   801016b0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104a96:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80104a9d:	00 
80104a9e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104aa2:	89 3c 24             	mov    %edi,(%esp)
80104aa5:	e8 16 d1 ff ff       	call   80101bc0 <dirlookup>
80104aaa:	85 c0                	test   %eax,%eax
80104aac:	89 c6                	mov    %eax,%esi
80104aae:	74 40                	je     80104af0 <create+0x90>
    iunlockput(dp);
80104ab0:	89 3c 24             	mov    %edi,(%esp)
80104ab3:	e8 58 ce ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104ab8:	89 34 24             	mov    %esi,(%esp)
80104abb:	e8 f0 cb ff ff       	call   801016b0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104ac0:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104ac5:	75 11                	jne    80104ad8 <create+0x78>
80104ac7:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104acc:	89 f0                	mov    %esi,%eax
80104ace:	75 08                	jne    80104ad8 <create+0x78>
...
80104ad0:	83 c4 3c             	add    $0x3c,%esp
80104ad3:	5b                   	pop    %ebx
80104ad4:	5e                   	pop    %esi
80104ad5:	5f                   	pop    %edi
80104ad6:	5d                   	pop    %ebp
...
80104adb:	e8 30 ce ff ff       	call   80101910 <iunlockput>
}
80104ae0:	83 c4 3c             	add    $0x3c,%esp
    return 0;
...
80104af0:	0f bf 45 d4          	movswl -0x2c(%ebp),%eax
80104af4:	89 44 24 04          	mov    %eax,0x4(%esp)
80104af8:	8b 07                	mov    (%edi),%eax
80104afa:	89 04 24             	mov    %eax,(%esp)
80104afd:	e8 1e ca ff ff       	call   80101520 <ialloc>
80104b02:	85 c0                	test   %eax,%eax
80104b04:	89 c6                	mov    %eax,%esi
80104b06:	0f 84 bf 00 00 00    	je     80104bcb <create+0x16b>
  ilock(ip);
80104b0c:	89 04 24             	mov    %eax,(%esp)
80104b0f:	e8 9c cb ff ff       	call   801016b0 <ilock>
  ip->major = major;
80104b14:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80104b18:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
80104b1c:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80104b20:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80104b24:	b8 01 00 00 00       	mov    $0x1,%eax
80104b29:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
80104b2d:	89 34 24             	mov    %esi,(%esp)
80104b30:	e8 bb ca ff ff       	call   801015f0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104b35:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80104b3a:	74 34                	je     80104b70 <create+0x110>
  if(dirlink(dp, name, ip->inum) < 0)
80104b3c:	8b 46 04             	mov    0x4(%esi),%eax
80104b3f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
...
80104b6a:	e9 61 ff ff ff       	jmp    80104ad0 <create+0x70>
80104b6f:	90                   	nop
    dp->nlink++;  // for ".."
80104b70:	66 83 47 56 01       	addw   $0x1,0x56(%edi)
    iupdate(dp);
80104b75:	89 3c 24             	mov    %edi,(%esp)
80104b78:	e8 73 ca ff ff       	call   801015f0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104b7d:	8b 46 04             	mov    0x4(%esi),%eax
80104b80:	c7 44 24 04 a0 77 10 	movl   $0x801077a0,0x4(%esp)
80104b87:	80 
80104b88:	89 34 24             	mov    %esi,(%esp)
80104b8b:	89 44 24 08          	mov    %eax,0x8(%esp)
80104b8f:	e8 8c d2 ff ff       	call   80101e20 <dirlink>
80104b94:	85 c0                	test   %eax,%eax
80104b96:	78 1b                	js     80104bb3 <create+0x153>
80104b98:	8b 47 04             	mov    0x4(%edi),%eax
80104b9b:	c7 44 24 04 9f 77 10 	movl   $0x8010779f,0x4(%esp)
80104ba2:	80 
80104ba3:	89 34 24             	mov    %esi,(%esp)
80104ba6:	89 44 24 08          	mov    %eax,0x8(%esp)
80104baa:	e8 71 d2 ff ff       	call   80101e20 <dirlink>
80104baf:	85 c0                	test   %eax,%eax
80104bb1:	79 89                	jns    80104b3c <create+0xdc>
      panic("create dots");
80104bb3:	c7 04 24 93 77 10 80 	movl   $0x80107793,(%esp)
80104bba:	e8 a1 b7 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
80104bbf:	c7 04 24 a2 77 10 80 	movl   $0x801077a2,(%esp)
80104bc6:	e8 95 b7 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
80104bcb:	c7 04 24 84 77 10 80 	movl   $0x80107784,(%esp)
80104bd2:	e8 89 b7 ff ff       	call   80100360 <panic>
...
80104be7:	89 d3                	mov    %edx,%ebx
80104be9:	83 ec 20             	sub    $0x20,%esp
  if(argint(n, &fd) < 0)
80104bec:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104bef:	89 44 24 04          	mov    %eax,0x4(%esp)
80104bf3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104bfa:	e8 e1 fc ff ff       	call   801048e0 <argint>
80104bff:	85 c0                	test   %eax,%eax
80104c01:	78 2d                	js     80104c30 <argfd.constprop.0+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104c03:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104c07:	77 27                	ja     80104c30 <argfd.constprop.0+0x50>
80104c09:	e8 92 ea ff ff       	call   801036a0 <myproc>
80104c0e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104c11:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104c15:	85 c0                	test   %eax,%eax
80104c17:	74 17                	je     80104c30 <argfd.constprop.0+0x50>
  if(pfd)
80104c19:	85 f6                	test   %esi,%esi
80104c1b:	74 02                	je     80104c1f <argfd.constprop.0+0x3f>
    *pfd = fd;
80104c1d:	89 16                	mov    %edx,(%esi)
  if(pf)
80104c1f:	85 db                	test   %ebx,%ebx
80104c21:	74 1d                	je     80104c40 <argfd.constprop.0+0x60>
    *pf = f;
80104c23:	89 03                	mov    %eax,(%ebx)
  return 0;
80104c25:	31 c0                	xor    %eax,%eax
}
80104c27:	83 c4 20             	add    $0x20,%esp
80104c2a:	5b                   	pop    %ebx
80104c2b:	5e                   	pop    %esi
80104c2c:	5d                   	pop    %ebp
80104c2d:	c3                   	ret    
80104c2e:	66 90                	xchg   %ax,%ax
80104c30:	83 c4 20             	add    $0x20,%esp
    return -1;
...
80104c42:	eb e3                	jmp    80104c27 <argfd.constprop.0+0x47>
...
80104c56:	83 ec 24             	sub    $0x24,%esp
  if(argfd(0, 0, &f) < 0)
80104c59:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104c5c:	e8 7f ff ff ff       	call   80104be0 <argfd.constprop.0>
80104c61:	85 c0                	test   %eax,%eax
80104c63:	78 23                	js     80104c88 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
80104c65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c68:	e8 b3 fd ff ff       	call   80104a20 <fdalloc>
80104c6d:	85 c0                	test   %eax,%eax
80104c6f:	89 c3                	mov    %eax,%ebx
80104c71:	78 15                	js     80104c88 <sys_dup+0x38>
  filedup(f);
80104c73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c76:	89 04 24             	mov    %eax,(%esp)
80104c79:	e8 62 c1 ff ff       	call   80100de0 <filedup>
  return fd;
80104c7e:	89 d8                	mov    %ebx,%eax
}
80104c80:	83 c4 24             	add    $0x24,%esp
80104c83:	5b                   	pop    %ebx
80104c84:	5d                   	pop    %ebp
80104c85:	c3                   	ret    
...
80104c8d:	eb f1                	jmp    80104c80 <sys_dup+0x30>
80104c8f:	90                   	nop
...
80104c9b:	e8 40 ff ff ff       	call   80104be0 <argfd.constprop.0>
80104ca0:	85 c0                	test   %eax,%eax
80104ca2:	78 54                	js     80104cf8 <sys_read+0x68>
80104ca4:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104ca7:	89 44 24 04          	mov    %eax,0x4(%esp)
80104cab:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104cb2:	e8 29 fc ff ff       	call   801048e0 <argint>
80104cb7:	85 c0                	test   %eax,%eax
80104cb9:	78 3d                	js     80104cf8 <sys_read+0x68>
...
80104cd0:	e8 3b fc ff ff       	call   80104910 <argptr>
80104cd5:	85 c0                	test   %eax,%eax
80104cd7:	78 1f                	js     80104cf8 <sys_read+0x68>
...
80104ced:	e8 4e c2 ff ff       	call   80100f40 <fileread>
}
80104cf2:	c9                   	leave  
80104cf3:	c3                   	ret    
...
80104d0b:	e8 d0 fe ff ff       	call   80104be0 <argfd.constprop.0>
80104d10:	85 c0                	test   %eax,%eax
80104d12:	78 54                	js     80104d68 <sys_write+0x68>
80104d14:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d17:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d1b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104d22:	e8 b9 fb ff ff       	call   801048e0 <argint>
80104d27:	85 c0                	test   %eax,%eax
80104d29:	78 3d                	js     80104d68 <sys_write+0x68>
80104d2b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104d35:	89 44 24 08          	mov    %eax,0x8(%esp)
80104d39:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104d3c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d40:	e8 cb fb ff ff       	call   80104910 <argptr>
80104d45:	85 c0                	test   %eax,%eax
80104d47:	78 1f                	js     80104d68 <sys_write+0x68>
  return filewrite(f, p, n);
80104d49:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d4c:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80104d7c:	e8 5f fe ff ff       	call   80104be0 <argfd.constprop.0>
80104d81:	85 c0                	test   %eax,%eax
80104d83:	78 23                	js     80104da8 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104d85:	e8 16 e9 ff ff       	call   801036a0 <myproc>
80104d8a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104d8d:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104d94:	00 
  fileclose(f);
...
80104dbb:	e8 20 fe ff ff       	call   80104be0 <argfd.constprop.0>
80104dc0:	85 c0                	test   %eax,%eax
80104dc2:	78 34                	js     80104df8 <sys_fstat+0x48>
80104dc4:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104dc7:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80104dce:	00 
80104dcf:	89 44 24 04          	mov    %eax,0x4(%esp)
80104dd3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104dda:	e8 31 fb ff ff       	call   80104910 <argptr>
80104ddf:	85 c0                	test   %eax,%eax
80104de1:	78 15                	js     80104df8 <sys_fstat+0x48>
...
80104df0:	e8 fb c0 ff ff       	call   80100ef0 <filestat>
}
80104df5:	c9                   	leave  
80104df6:	c3                   	ret    
80104df7:	90                   	nop
...
80104e06:	83 ec 3c             	sub    $0x3c,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80104e09:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80104e0c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e10:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104e17:	e8 54 fb ff ff       	call   80104970 <argstr>
80104e1c:	85 c0                	test   %eax,%eax
80104e1e:	0f 88 e6 00 00 00    	js     80104f0a <sys_link+0x10a>
80104e24:	8d 45 d0             	lea    -0x30(%ebp),%eax
80104e27:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e2b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104e32:	e8 39 fb ff ff       	call   80104970 <argstr>
80104e37:	85 c0                	test   %eax,%eax
80104e39:	0f 88 cb 00 00 00    	js     80104f0a <sys_link+0x10a>
  begin_op();
80104e3f:	e8 cc dc ff ff       	call   80102b10 <begin_op>
  if((ip = namei(old)) == 0){
80104e44:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104e47:	89 04 24             	mov    %eax,(%esp)
80104e4a:	e8 b1 d0 ff ff       	call   80101f00 <namei>
80104e4f:	85 c0                	test   %eax,%eax
80104e51:	89 c3                	mov    %eax,%ebx
80104e53:	0f 84 ac 00 00 00    	je     80104f05 <sys_link+0x105>
  ilock(ip);
80104e59:	89 04 24             	mov    %eax,(%esp)
80104e5c:	e8 4f c8 ff ff       	call   801016b0 <ilock>
  if(ip->type == T_DIR){
80104e61:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104e66:	0f 84 91 00 00 00    	je     80104efd <sys_link+0xfd>
  ip->nlink++;
80104e6c:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80104e71:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80104e74:	89 1c 24             	mov    %ebx,(%esp)
80104e77:	e8 74 c7 ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
80104e7c:	89 1c 24             	mov    %ebx,(%esp)
80104e7f:	e8 0c c9 ff ff       	call   80101790 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104e84:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104e87:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104e8b:	89 04 24             	mov    %eax,(%esp)
80104e8e:	e8 8d d0 ff ff       	call   80101f20 <nameiparent>
80104e93:	85 c0                	test   %eax,%eax
80104e95:	89 c6                	mov    %eax,%esi
80104e97:	74 4f                	je     80104ee8 <sys_link+0xe8>
  ilock(dp);
80104e99:	89 04 24             	mov    %eax,(%esp)
80104e9c:	e8 0f c8 ff ff       	call   801016b0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104ea1:	8b 03                	mov    (%ebx),%eax
80104ea3:	39 06                	cmp    %eax,(%esi)
80104ea5:	75 39                	jne    80104ee0 <sys_link+0xe0>
80104ea7:	8b 43 04             	mov    0x4(%ebx),%eax
80104eaa:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104eae:	89 34 24             	mov    %esi,(%esp)
80104eb1:	89 44 24 08          	mov    %eax,0x8(%esp)
80104eb5:	e8 66 cf ff ff       	call   80101e20 <dirlink>
80104eba:	85 c0                	test   %eax,%eax
80104ebc:	78 22                	js     80104ee0 <sys_link+0xe0>
  iunlockput(dp);
80104ebe:	89 34 24             	mov    %esi,(%esp)
80104ec1:	e8 4a ca ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104ec6:	89 1c 24             	mov    %ebx,(%esp)
80104ec9:	e8 02 c9 ff ff       	call   801017d0 <iput>
  end_op();
80104ece:	e8 ad dc ff ff       	call   80102b80 <end_op>
}
80104ed3:	83 c4 3c             	add    $0x3c,%esp
  return 0;
...
80104f0a:	83 c4 3c             	add    $0x3c,%esp
  return -1;
...
80104f26:	83 ec 5c             	sub    $0x5c,%esp
  if(argstr(0, &path) < 0)
80104f29:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104f2c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f30:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104f37:	e8 34 fa ff ff       	call   80104970 <argstr>
80104f3c:	85 c0                	test   %eax,%eax
80104f3e:	0f 88 76 01 00 00    	js     801050ba <sys_unlink+0x19a>
  begin_op();
80104f44:	e8 c7 db ff ff       	call   80102b10 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104f49:	8b 45 c0             	mov    -0x40(%ebp),%eax
80104f4c:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80104f4f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104f53:	89 04 24             	mov    %eax,(%esp)
80104f56:	e8 c5 cf ff ff       	call   80101f20 <nameiparent>
80104f5b:	85 c0                	test   %eax,%eax
80104f5d:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80104f60:	0f 84 4f 01 00 00    	je     801050b5 <sys_unlink+0x195>
  ilock(dp);
80104f66:	8b 75 b4             	mov    -0x4c(%ebp),%esi
80104f69:	89 34 24             	mov    %esi,(%esp)
80104f6c:	e8 3f c7 ff ff       	call   801016b0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104f71:	c7 44 24 04 a0 77 10 	movl   $0x801077a0,0x4(%esp)
80104f78:	80 
80104f79:	89 1c 24             	mov    %ebx,(%esp)
80104f7c:	e8 0f cc ff ff       	call   80101b90 <namecmp>
80104f81:	85 c0                	test   %eax,%eax
80104f83:	0f 84 21 01 00 00    	je     801050aa <sys_unlink+0x18a>
80104f89:	c7 44 24 04 9f 77 10 	movl   $0x8010779f,0x4(%esp)
80104f90:	80 
80104f91:	89 1c 24             	mov    %ebx,(%esp)
80104f94:	e8 f7 cb ff ff       	call   80101b90 <namecmp>
80104f99:	85 c0                	test   %eax,%eax
80104f9b:	0f 84 09 01 00 00    	je     801050aa <sys_unlink+0x18a>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104fa1:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80104fa4:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104fa8:	89 44 24 08          	mov    %eax,0x8(%esp)
80104fac:	89 34 24             	mov    %esi,(%esp)
80104faf:	e8 0c cc ff ff       	call   80101bc0 <dirlookup>
80104fb4:	85 c0                	test   %eax,%eax
80104fb6:	89 c3                	mov    %eax,%ebx
80104fb8:	0f 84 ec 00 00 00    	je     801050aa <sys_unlink+0x18a>
  ilock(ip);
80104fbe:	89 04 24             	mov    %eax,(%esp)
80104fc1:	e8 ea c6 ff ff       	call   801016b0 <ilock>
  if(ip->nlink < 1)
80104fc6:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104fcb:	0f 8e 24 01 00 00    	jle    801050f5 <sys_unlink+0x1d5>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104fd1:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104fd6:	8d 75 d8             	lea    -0x28(%ebp),%esi
80104fd9:	74 7d                	je     80105058 <sys_unlink+0x138>
  memset(&de, 0, sizeof(de));
80104fdb:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104fe2:	00 
80104fe3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104fea:	00 
80104feb:	89 34 24             	mov    %esi,(%esp)
80104fee:	e8 fd f5 ff ff       	call   801045f0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104ff3:	8b 45 c4             	mov    -0x3c(%ebp),%eax
80104ff6:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80104ffd:	00 
80104ffe:	89 74 24 04          	mov    %esi,0x4(%esp)
80105002:	89 44 24 08          	mov    %eax,0x8(%esp)
80105006:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80105009:	89 04 24             	mov    %eax,(%esp)
8010500c:	e8 4f ca ff ff       	call   80101a60 <writei>
80105011:	83 f8 10             	cmp    $0x10,%eax
80105014:	0f 85 cf 00 00 00    	jne    801050e9 <sys_unlink+0x1c9>
  if(ip->type == T_DIR){
8010501a:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010501f:	0f 84 a3 00 00 00    	je     801050c8 <sys_unlink+0x1a8>
  iunlockput(dp);
80105025:	8b 45 b4             	mov    -0x4c(%ebp),%eax
...
80105038:	e8 b3 c5 ff ff       	call   801015f0 <iupdate>
  iunlockput(ip);
...
80105058:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
8010505c:	0f 86 79 ff ff ff    	jbe    80104fdb <sys_unlink+0xbb>
80105062:	bf 20 00 00 00       	mov    $0x20,%edi
80105067:	eb 15                	jmp    8010507e <sys_unlink+0x15e>
80105069:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105070:	8d 57 10             	lea    0x10(%edi),%edx
80105073:	3b 53 58             	cmp    0x58(%ebx),%edx
80105076:	0f 83 5f ff ff ff    	jae    80104fdb <sys_unlink+0xbb>
8010507c:	89 d7                	mov    %edx,%edi
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010507e:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105085:	00 
80105086:	89 7c 24 08          	mov    %edi,0x8(%esp)
8010508a:	89 74 24 04          	mov    %esi,0x4(%esp)
8010508e:	89 1c 24             	mov    %ebx,(%esp)
80105091:	e8 ca c8 ff ff       	call   80101960 <readi>
80105096:	83 f8 10             	cmp    $0x10,%eax
80105099:	75 42                	jne    801050dd <sys_unlink+0x1bd>
    if(de.inum != 0)
8010509b:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
801050a0:	74 ce                	je     80105070 <sys_unlink+0x150>
    iunlockput(ip);
801050a2:	89 1c 24             	mov    %ebx,(%esp)
801050a5:	e8 66 c8 ff ff       	call   80101910 <iunlockput>
  iunlockput(dp);
801050aa:	8b 45 b4             	mov    -0x4c(%ebp),%eax
801050ad:	89 04 24             	mov    %eax,(%esp)
801050b0:	e8 5b c8 ff ff       	call   80101910 <iunlockput>
  end_op();
801050b5:	e8 c6 da ff ff       	call   80102b80 <end_op>
}
801050ba:	83 c4 5c             	add    $0x5c,%esp
  return -1;
...
801050d3:	e8 18 c5 ff ff       	call   801015f0 <iupdate>
801050d8:	e9 48 ff ff ff       	jmp    80105025 <sys_unlink+0x105>
      panic("isdirempty: readi");
801050dd:	c7 04 24 c4 77 10 80 	movl   $0x801077c4,(%esp)
801050e4:	e8 77 b2 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
801050e9:	c7 04 24 d6 77 10 80 	movl   $0x801077d6,(%esp)
801050f0:	e8 6b b2 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
801050f5:	c7 04 24 b2 77 10 80 	movl   $0x801077b2,(%esp)
801050fc:	e8 5f b2 ff ff       	call   80100360 <panic>
...
80105116:	83 ec 2c             	sub    $0x2c,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105119:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010511c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105120:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105127:	e8 44 f8 ff ff       	call   80104970 <argstr>
8010512c:	85 c0                	test   %eax,%eax
8010512e:	0f 88 d1 00 00 00    	js     80105205 <sys_open+0xf5>
80105134:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105137:	89 44 24 04          	mov    %eax,0x4(%esp)
8010513b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105142:	e8 99 f7 ff ff       	call   801048e0 <argint>
80105147:	85 c0                	test   %eax,%eax
80105149:	0f 88 b6 00 00 00    	js     80105205 <sys_open+0xf5>
    return -1;

  begin_op();
8010514f:	e8 bc d9 ff ff       	call   80102b10 <begin_op>

  if(omode & O_CREATE){
80105154:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105158:	0f 85 82 00 00 00    	jne    801051e0 <sys_open+0xd0>
    if(ip == 0){
      end_op();
      return -1;
    }
    ...
    if((ip = namei(path)) == 0){
8010515e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105161:	89 04 24             	mov    %eax,(%esp)
80105164:	e8 97 cd ff ff       	call   80101f00 <namei>
80105169:	85 c0                	test   %eax,%eax
8010516b:	89 c6                	mov    %eax,%esi
8010516d:	0f 84 8d 00 00 00    	je     80105200 <sys_open+0xf0>
      end_op();
      return -1;
    }
    ilock(ip);
80105173:	89 04 24             	mov    %eax,(%esp)
80105176:	e8 35 c5 ff ff       	call   801016b0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010517b:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105180:	0f 84 92 00 00 00    	je     80105218 <sys_open+0x108>
      end_op();
      return -1;
    }
  }
...
8010518f:	0f 84 93 00 00 00    	je     80105228 <sys_open+0x118>
80105195:	e8 86 f8 ff ff       	call   80104a20 <fdalloc>
8010519a:	85 c0                	test   %eax,%eax
8010519c:	89 c7                	mov    %eax,%edi
8010519e:	0f 88 94 00 00 00    	js     80105238 <sys_open+0x128>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
  ...
  iunlock(ip);
801051a4:	89 34 24             	mov    %esi,(%esp)
801051a7:	e8 e4 c5 ff ff       	call   80101790 <iunlock>
  end_op();
801051ac:	e8 cf d9 ff ff       	call   80102b80 <end_op>

  f->type = FD_INODE;
801051b1:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
801051b7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  f->ip = ip;
801051ba:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
801051bd:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
801051c4:	89 c2                	mov    %eax,%edx
801051c6:	83 e2 01             	and    $0x1,%edx
801051c9:	83 f2 01             	xor    $0x1,%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801051cc:	a8 03                	test   $0x3,%al
  f->readable = !(omode & O_WRONLY);
801051ce:	88 53 08             	mov    %dl,0x8(%ebx)
  return fd;
801051d1:	89 f8                	mov    %edi,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801051d3:	0f 95 43 09          	setne  0x9(%ebx)
}
801051d7:	83 c4 2c             	add    $0x2c,%esp
801051da:	5b                   	pop    %ebx
801051db:	5e                   	pop    %esi
801051dc:	5f                   	pop    %edi
801051dd:	5d                   	pop    %ebp
...
801051e0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801051e3:	31 c9                	xor    %ecx,%ecx
801051e5:	ba 02 00 00 00       	mov    $0x2,%edx
801051ea:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801051f1:	e8 6a f8 ff ff       	call   80104a60 <create>
    if(ip == 0){
801051f6:	85 c0                	test   %eax,%eax
    ip = create(path, T_FILE, 0, 0);
801051f8:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801051fa:	75 8a                	jne    80105186 <sys_open+0x76>
801051fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    end_op();
80105200:	e8 7b d9 ff ff       	call   80102b80 <end_op>
}
80105205:	83 c4 2c             	add    $0x2c,%esp
    return -1;
...
80105269:	e8 02 f7 ff ff       	call   80104970 <argstr>
8010526e:	85 c0                	test   %eax,%eax
80105270:	78 2e                	js     801052a0 <sys_mkdir+0x50>
80105272:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105275:	31 c9                	xor    %ecx,%ecx
80105277:	ba 01 00 00 00       	mov    $0x1,%edx
8010527c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105283:	e8 d8 f7 ff ff       	call   80104a60 <create>
80105288:	85 c0                	test   %eax,%eax
8010528a:	74 14                	je     801052a0 <sys_mkdir+0x50>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
8010528f:	e8 7c c6 ff ff       	call   80101910 <iunlockput>
  end_op();
80105294:	e8 e7 d8 ff ff       	call   80102b80 <end_op>
  return 0;
80105299:	31 c0                	xor    %eax,%eax
}
8010529b:	c9                   	leave  
8010529c:	c3                   	ret    
8010529d:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
801052a0:	e8 db d8 ff ff       	call   80102b80 <end_op>
    return -1;
...
801052b3:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801052b6:	e8 55 d8 ff ff       	call   80102b10 <begin_op>
  if((argstr(0, &path)) < 0 ||
801052bb:	8d 45 ec             	lea    -0x14(%ebp),%eax
801052be:	89 44 24 04          	mov    %eax,0x4(%esp)
801052c2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801052c9:	e8 a2 f6 ff ff       	call   80104970 <argstr>
801052ce:	85 c0                	test   %eax,%eax
801052d0:	78 5e                	js     80105330 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
801052d2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801052d5:	89 44 24 04          	mov    %eax,0x4(%esp)
801052d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801052e0:	e8 fb f5 ff ff       	call   801048e0 <argint>
  if((argstr(0, &path)) < 0 ||
801052e5:	85 c0                	test   %eax,%eax
801052e7:	78 47                	js     80105330 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
801052e9:	8d 45 f4             	lea    -0xc(%ebp),%eax
801052ec:	89 44 24 04          	mov    %eax,0x4(%esp)
801052f0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801052f7:	e8 e4 f5 ff ff       	call   801048e0 <argint>
     argint(1, &major) < 0 ||
801052fc:	85 c0                	test   %eax,%eax
801052fe:	78 30                	js     80105330 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
80105300:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
     argint(2, &minor) < 0 ||
80105304:	ba 03 00 00 00       	mov    $0x3,%edx
     (ip = create(path, T_DEV, major, minor)) == 0){
80105309:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
8010530d:	89 04 24             	mov    %eax,(%esp)
     argint(2, &minor) < 0 ||
80105310:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105313:	e8 48 f7 ff ff       	call   80104a60 <create>
80105318:	85 c0                	test   %eax,%eax
8010531a:	74 14                	je     80105330 <sys_mknod+0x80>
    end_op();
    return -1;
  }
  iunlockput(ip);
8010531c:	89 04 24             	mov    %eax,(%esp)
8010531f:	e8 ec c5 ff ff       	call   80101910 <iunlockput>
  end_op();
80105324:	e8 57 d8 ff ff       	call   80102b80 <end_op>
  return 0;
...
8010532d:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
80105330:	e8 4b d8 ff ff       	call   80102b80 <end_op>
    return -1;
...
80105345:	83 ec 20             	sub    $0x20,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
80105348:	e8 53 e3 ff ff       	call   801036a0 <myproc>
8010534d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010534f:	e8 bc d7 ff ff       	call   80102b10 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105354:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105357:	89 44 24 04          	mov    %eax,0x4(%esp)
8010535b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105362:	e8 09 f6 ff ff       	call   80104970 <argstr>
80105367:	85 c0                	test   %eax,%eax
80105369:	78 4a                	js     801053b5 <sys_chdir+0x75>
8010536b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010536e:	89 04 24             	mov    %eax,(%esp)
80105371:	e8 8a cb ff ff       	call   80101f00 <namei>
80105376:	85 c0                	test   %eax,%eax
80105378:	89 c3                	mov    %eax,%ebx
8010537a:	74 39                	je     801053b5 <sys_chdir+0x75>
    end_op();
    return -1;
  }
  ilock(ip);
8010537c:	89 04 24             	mov    %eax,(%esp)
8010537f:	e8 2c c3 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
80105384:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
    iunlockput(ip);
80105389:	89 1c 24             	mov    %ebx,(%esp)
  if(ip->type != T_DIR){
8010538c:	75 22                	jne    801053b0 <sys_chdir+0x70>
    end_op();
    return -1;
  }
  iunlock(ip);
8010538e:	e8 fd c3 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105393:	8b 46 68             	mov    0x68(%esi),%eax
80105396:	89 04 24             	mov    %eax,(%esp)
80105399:	e8 32 c4 ff ff       	call   801017d0 <iput>
  end_op();
8010539e:	e8 dd d7 ff ff       	call   80102b80 <end_op>
  curproc->cwd = ip;
  return 0;
801053a3:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
801053a5:	89 5e 68             	mov    %ebx,0x68(%esi)
}
...
801053af:	90                   	nop
    iunlockput(ip);
801053b0:	e8 5b c5 ff ff       	call   80101910 <iunlockput>
    end_op();
801053b5:	e8 c6 d7 ff ff       	call   80102b80 <end_op>
}
801053ba:	83 c4 20             	add    $0x20,%esp
    return -1;
...
801053d6:	81 ec ac 00 00 00    	sub    $0xac,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
801053dc:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
801053e2:	89 44 24 04          	mov    %eax,0x4(%esp)
801053e6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801053ed:	e8 7e f5 ff ff       	call   80104970 <argstr>
801053f2:	85 c0                	test   %eax,%eax
801053f4:	0f 88 84 00 00 00    	js     8010547e <sys_exec+0xae>
801053fa:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105400:	89 44 24 04          	mov    %eax,0x4(%esp)
80105404:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010540b:	e8 d0 f4 ff ff       	call   801048e0 <argint>
80105410:	85 c0                	test   %eax,%eax
80105412:	78 6a                	js     8010547e <sys_exec+0xae>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105414:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
8010541a:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
8010541c:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80105423:	00 
80105424:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
8010542a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105431:	00 
80105432:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105438:	89 04 24             	mov    %eax,(%esp)
8010543b:	e8 b0 f1 ff ff       	call   801045f0 <memset>
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105440:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105446:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010544a:	8d 04 98             	lea    (%eax,%ebx,4),%eax
8010544d:	89 04 24             	mov    %eax,(%esp)
80105450:	e8 eb f3 ff ff       	call   80104840 <fetchint>
80105455:	85 c0                	test   %eax,%eax
80105457:	78 25                	js     8010547e <sys_exec+0xae>
      return -1;
    if(uarg == 0){
80105459:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
8010545f:	85 c0                	test   %eax,%eax
80105461:	74 2d                	je     80105490 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80105463:	89 74 24 04          	mov    %esi,0x4(%esp)
80105467:	89 04 24             	mov    %eax,(%esp)
8010546a:	e8 11 f4 ff ff       	call   80104880 <fetchstr>
8010546f:	85 c0                	test   %eax,%eax
80105471:	78 0b                	js     8010547e <sys_exec+0xae>
  for(i=0;; i++){
80105473:	83 c3 01             	add    $0x1,%ebx
80105476:	83 c6 04             	add    $0x4,%esi
    if(i >= NELEM(argv))
80105479:	83 fb 20             	cmp    $0x20,%ebx
8010547c:	75 c2                	jne    80105440 <sys_exec+0x70>
      return -1;
  }
  return exec(path, argv);
}
8010547e:	81 c4 ac 00 00 00    	add    $0xac,%esp
    return -1;
...
8010549a:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
      argv[i] = 0;
801054a0:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
801054a7:	00 00 00 00 
  return exec(path, argv);
801054ab:	89 04 24             	mov    %eax,(%esp)
801054ae:	e8 ed b4 ff ff       	call   801009a0 <exec>
}
801054b3:	81 c4 ac 00 00 00    	add    $0xac,%esp
801054b9:	5b                   	pop    %ebx
801054ba:	5e                   	pop    %esi
801054bb:	5f                   	pop    %edi
801054bc:	5d                   	pop    %ebp
...
801054c7:	8d 45 ec             	lea    -0x14(%ebp),%eax
801054ca:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801054d1:	00 
801054d2:	89 44 24 04          	mov    %eax,0x4(%esp)
801054d6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801054dd:	e8 2e f4 ff ff       	call   80104910 <argptr>
801054e2:	85 c0                	test   %eax,%eax
801054e4:	78 6d                	js     80105553 <sys_pipe+0x93>
    return -1;
...
801054f3:	e8 78 dc ff ff       	call   80103170 <pipealloc>
801054f8:	85 c0                	test   %eax,%eax
801054fa:	78 57                	js     80105553 <sys_pipe+0x93>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801054fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054ff:	e8 1c f5 ff ff       	call   80104a20 <fdalloc>
80105504:	85 c0                	test   %eax,%eax
80105506:	89 c3                	mov    %eax,%ebx
80105508:	78 33                	js     8010553d <sys_pipe+0x7d>
8010550a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010550d:	e8 0e f5 ff ff       	call   80104a20 <fdalloc>
80105512:	85 c0                	test   %eax,%eax
80105514:	78 1a                	js     80105530 <sys_pipe+0x70>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
80105519:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
8010551b:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010551e:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
}
80105521:	83 c4 24             	add    $0x24,%esp
  return 0;
...
80105535:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
8010553c:	00 
    fileclose(rf);
8010553d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105540:	89 04 24             	mov    %eax,(%esp)
80105543:	e8 e8 b8 ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
80105548:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010554b:	89 04 24             	mov    %eax,(%esp)
8010554e:	e8 dd b8 ff ff       	call   80100e30 <fileclose>
}
80105553:	83 c4 24             	add    $0x24,%esp
    return -1;
...
80105563:	5d                   	pop    %ebp
  return fork();
80105564:	e9 e7 e2 ff ff       	jmp    80103850 <fork>
...
80105573:	83 ec 08             	sub    $0x8,%esp
  exit();
80105576:	e8 b5 e5 ff ff       	call   80103b30 <exit>
...
80105589:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105590:	00 
80105591:	89 44 24 04          	mov    %eax,0x4(%esp)
80105595:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010559c:	e8 6f f3 ff ff       	call   80104910 <argptr>
801055a1:	85 c0                	test   %eax,%eax
801055a3:	78 13                	js     801055b8 <sys_wait+0x38>
	return -1;
  return wait(status);
801055a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055a8:	89 04 24             	mov    %eax,(%esp)
801055ab:	e8 a0 e7 ff ff       	call   80103d50 <wait>
}
801055b0:	c9                   	leave  
801055b1:	c3                   	ret    
...
801055d4:	e8 07 f3 ff ff       	call   801048e0 <argint>
...
801055e3:	e8 c8 e8 ff ff       	call   80103eb0 <kill>
}
801055e8:	c9                   	leave  
801055e9:	c3                   	ret    
...
80105603:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105606:	e8 95 e0 ff ff       	call   801036a0 <myproc>
...
80105625:	e8 b6 f2 ff ff       	call   801048e0 <argint>
8010562a:	85 c0                	test   %eax,%eax
8010562c:	78 22                	js     80105650 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010562e:	e8 6d e0 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
...
8010563b:	e8 a0 e1 ff ff       	call   801037e0 <growproc>
...
80105675:	e8 66 f2 ff ff       	call   801048e0 <argint>
8010567a:	85 c0                	test   %eax,%eax
8010567c:	78 7e                	js     801056fc <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010567e:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105685:	e8 a6 ee ff ff       	call   80104530 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010568a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010568d:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
...
801056a0:	c7 44 24 04 60 4e 11 	movl   $0x80114e60,0x4(%esp)
801056a7:	80 
801056a8:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
801056af:	e8 ec e5 ff ff       	call   80103ca0 <sleep>
  while(ticks - ticks0 < n){
801056b4:	a1 a0 56 11 80       	mov    0x801156a0,%eax
...
801056ca:	74 d4                	je     801056a0 <sys_sleep+0x40>
      release(&tickslock);
801056cc:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801056d3:	e8 c8 ee ff ff       	call   801045a0 <release>
      return -1;
...
801056e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
801056e8:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801056ef:	e8 ac ee ff ff       	call   801045a0 <release>
}
...
80105714:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105717:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
8010571e:	e8 0d ee ff ff       	call   80104530 <acquire>
  xticks = ticks;
80105723:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
80105729:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105730:	e8 6b ee ff ff       	call   801045a0 <release>
  return xticks;
}
...
80105754:	e8 87 f1 ff ff       	call   801048e0 <argint>
  exitS(status);
80105759:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010575c:	89 04 24             	mov    %eax,(%esp)
8010575f:	e8 9c e8 ff ff       	call   80104000 <exitS>
  return 0;
}
...
80105784:	e8 57 f1 ff ff       	call   801048e0 <argint>
  int *status;
  if(argptr(1,(void*)&status,sizeof(*status))<0)
80105789:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010578c:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105793:	00 
80105794:	89 44 24 04          	mov    %eax,0x4(%esp)
80105798:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010579f:	e8 6c f1 ff ff       	call   80104910 <argptr>
801057a4:	85 c0                	test   %eax,%eax
801057a6:	78 20                	js     801057c8 <sys_waitpid+0x58>
	return -1;
  return waitpid(pid, status, 0);
801057a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057ab:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801057b2:	00 
801057b3:	89 44 24 04          	mov    %eax,0x4(%esp)
801057b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057ba:	89 04 24             	mov    %eax,(%esp)
801057bd:	e8 6e e9 ff ff       	call   80104130 <waitpid>
}
801057c2:	c9                   	leave  
801057c3:	c3                   	ret    
...
801057e4:	e8 f7 f0 ff ff       	call   801048e0 <argint>
801057e9:	85 c0                	test   %eax,%eax
801057eb:	78 13                	js     80105800 <sys_set_prior+0x30>
		return -1;
	return set_prior(priority);
801057ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057f0:	89 04 24             	mov    %eax,(%esp)
801057f3:	e8 38 ea ff ff       	call   80104230 <set_prior>
}
801057f8:	c9                   	leave  
801057f9:	c3                   	ret    
...
80105844:	66 89 0c c5 a2 4e 11 	mov    %cx,-0x7feeb15e(,%eax,8)
8010584b:	80 
8010584c:	c6 04 c5 a4 4e 11 80 	movb   $0x0,-0x7feeb15c(,%eax,8)
80105853:	00 
80105854:	c6 04 c5 a5 4e 11 80 	movb   $0x8e,-0x7feeb15b(,%eax,8)
8010585b:	8e 
8010585c:	66 89 14 c5 a0 4e 11 	mov    %dx,-0x7feeb160(,%eax,8)
80105863:	80 
80105864:	c1 ea 10             	shr    $0x10,%edx
80105867:	66 89 14 c5 a6 4e 11 	mov    %dx,-0x7feeb15a(,%eax,8)
8010586e:	80 
  for(i = 0; i < 256; i++)
...
80105889:	c7 44 24 04 e5 77 10 	movl   $0x801077e5,0x4(%esp)
80105890:	80 
80105891:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105898:	66 89 15 a2 50 11 80 	mov    %dx,0x801150a2
8010589f:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
801058a5:	c1 e8 10             	shr    $0x10,%eax
801058a8:	c6 05 a4 50 11 80 00 	movb   $0x0,0x801150a4
801058af:	c6 05 a5 50 11 80 ef 	movb   $0xef,0x801150a5
801058b6:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
801058bc:	e8 ff ea ff ff       	call   801043c0 <initlock>
}
801058c1:	c9                   	leave  
801058c2:	c3                   	ret    
...
801058db:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801058df:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
...
8010591e:	77 08                	ja     80105928 <trap+0x28>
80105920:	ff 24 85 8c 78 10 80 	jmp    *-0x7fef8774(,%eax,4)
80105927:	90                   	nop
    lapiceoi();
    break;
...
80105928:	e8 73 dd ff ff       	call   801036a0 <myproc>
8010592d:	85 c0                	test   %eax,%eax
8010592f:	90                   	nop
80105930:	0f 84 fa 01 00 00    	je     80105b30 <trap+0x230>
80105936:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010593a:	0f 84 f0 01 00 00    	je     80105b30 <trap+0x230>
...
80105943:	8b 53 38             	mov    0x38(%ebx),%edx
80105946:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105949:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010594c:	e8 2f dd ff ff       	call   80103680 <cpuid>
80105951:	8b 73 30             	mov    0x30(%ebx),%esi
80105954:	89 c7                	mov    %eax,%edi
80105956:	8b 43 34             	mov    0x34(%ebx),%eax
80105959:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010595c:	e8 3f dd ff ff       	call   801036a0 <myproc>
80105961:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105964:	e8 37 dd ff ff       	call   801036a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105969:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010596c:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105970:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105973:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105976:	89 7c 24 14          	mov    %edi,0x14(%esp)
8010597a:	89 54 24 18          	mov    %edx,0x18(%esp)
8010597e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
80105981:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105984:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105988:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010598c:	89 54 24 10          	mov    %edx,0x10(%esp)
80105990:	8b 40 10             	mov    0x10(%eax),%eax
80105993:	c7 04 24 48 78 10 80 	movl   $0x80107848,(%esp)
8010599a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010599e:	e8 ad ac ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801059a3:	e8 f8 dc ff ff       	call   801036a0 <myproc>
801059a8:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801059af:	90                   	nop
  }
...
801059b0:	e8 eb dc ff ff       	call   801036a0 <myproc>
801059b5:	85 c0                	test   %eax,%eax
801059b7:	74 0c                	je     801059c5 <trap+0xc5>
801059b9:	e8 e2 dc ff ff       	call   801036a0 <myproc>
801059be:	8b 50 24             	mov    0x24(%eax),%edx
801059c1:	85 d2                	test   %edx,%edx
801059c3:	75 4b                	jne    80105a10 <trap+0x110>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801059c5:	e8 d6 dc ff ff       	call   801036a0 <myproc>
801059ca:	85 c0                	test   %eax,%eax
801059cc:	74 0d                	je     801059db <trap+0xdb>
801059ce:	66 90                	xchg   %ax,%ax
801059d0:	e8 cb dc ff ff       	call   801036a0 <myproc>
801059d5:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801059d9:	74 4d                	je     80105a28 <trap+0x128>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059db:	e8 c0 dc ff ff       	call   801036a0 <myproc>
801059e0:	85 c0                	test   %eax,%eax
801059e2:	74 1d                	je     80105a01 <trap+0x101>
801059e4:	e8 b7 dc ff ff       	call   801036a0 <myproc>
801059e9:	8b 40 24             	mov    0x24(%eax),%eax
801059ec:	85 c0                	test   %eax,%eax
801059ee:	74 11                	je     80105a01 <trap+0x101>
801059f0:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801059f4:	83 e0 03             	and    $0x3,%eax
801059f7:	66 83 f8 03          	cmp    $0x3,%ax
801059fb:	0f 84 e8 00 00 00    	je     80105ae9 <trap+0x1e9>
    exit();
}
80105a01:	83 c4 3c             	add    $0x3c,%esp
80105a04:	5b                   	pop    %ebx
80105a05:	5e                   	pop    %esi
80105a06:	5f                   	pop    %edi
80105a07:	5d                   	pop    %ebp
...
80105a1b:	75 a8                	jne    801059c5 <trap+0xc5>
    exit();
80105a1d:	e8 0e e1 ff ff       	call   80103b30 <exit>
80105a22:	eb a1                	jmp    801059c5 <trap+0xc5>
80105a24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->state == RUNNING &&
80105a28:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105a2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105a30:	75 a9                	jne    801059db <trap+0xdb>
    yield();
80105a32:	e8 29 e2 ff ff       	call   80103c60 <yield>
80105a37:	eb a2                	jmp    801059db <trap+0xdb>
80105a39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105a40:	e8 3b dc ff ff       	call   80103680 <cpuid>
80105a45:	85 c0                	test   %eax,%eax
80105a47:	0f 84 b3 00 00 00    	je     80105b00 <trap+0x200>
80105a4d:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80105a50:	e8 2b cd ff ff       	call   80102780 <lapiceoi>
    break;
80105a55:	e9 56 ff ff ff       	jmp    801059b0 <trap+0xb0>
...
80105a65:	e8 16 cd ff ff       	call   80102780 <lapiceoi>
    break;
80105a6a:	e9 41 ff ff ff       	jmp    801059b0 <trap+0xb0>
80105a6f:	90                   	nop
    uartintr();
80105a70:	e8 1b 02 00 00       	call   80105c90 <uartintr>
    lapiceoi();
80105a75:	e8 06 cd ff ff       	call   80102780 <lapiceoi>
    break;
80105a7a:	e9 31 ff ff ff       	jmp    801059b0 <trap+0xb0>
80105a7f:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105a80:	8b 7b 38             	mov    0x38(%ebx),%edi
80105a83:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105a87:	e8 f4 db ff ff       	call   80103680 <cpuid>
80105a8c:	c7 04 24 f0 77 10 80 	movl   $0x801077f0,(%esp)
80105a93:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80105a97:	89 74 24 08          	mov    %esi,0x8(%esp)
80105a9b:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a9f:	e8 ac ab ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105aa4:	e8 d7 cc ff ff       	call   80102780 <lapiceoi>
    break;
80105aa9:	e9 02 ff ff ff       	jmp    801059b0 <trap+0xb0>
80105aae:	66 90                	xchg   %ax,%ax
    ideintr();
80105ab0:	e8 cb c5 ff ff       	call   80102080 <ideintr>
80105ab5:	eb 96                	jmp    80105a4d <trap+0x14d>
80105ab7:	90                   	nop
80105ab8:	90                   	nop
80105ab9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105ac0:	e8 db db ff ff       	call   801036a0 <myproc>
80105ac5:	8b 70 24             	mov    0x24(%eax),%esi
80105ac8:	85 f6                	test   %esi,%esi
80105aca:	75 2c                	jne    80105af8 <trap+0x1f8>
    myproc()->tf = tf;
80105acc:	e8 cf db ff ff       	call   801036a0 <myproc>
80105ad1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105ad4:	e8 d7 ee ff ff       	call   801049b0 <syscall>
    if(myproc()->killed)
80105ad9:	e8 c2 db ff ff       	call   801036a0 <myproc>
80105ade:	8b 48 24             	mov    0x24(%eax),%ecx
80105ae1:	85 c9                	test   %ecx,%ecx
80105ae3:	0f 84 18 ff ff ff    	je     80105a01 <trap+0x101>
}
80105ae9:	83 c4 3c             	add    $0x3c,%esp
80105aec:	5b                   	pop    %ebx
80105aed:	5e                   	pop    %esi
80105aee:	5f                   	pop    %edi
80105aef:	5d                   	pop    %ebp
      exit();
80105af0:	e9 3b e0 ff ff       	jmp    80103b30 <exit>
80105af5:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105af8:	e8 33 e0 ff ff       	call   80103b30 <exit>
80105afd:	eb cd                	jmp    80105acc <trap+0x1cc>
80105aff:	90                   	nop
      acquire(&tickslock);
80105b00:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105b07:	e8 24 ea ff ff       	call   80104530 <acquire>
      wakeup(&ticks);
80105b0c:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
      ticks++;
80105b13:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
80105b1a:	e8 21 e3 ff ff       	call   80103e40 <wakeup>
      release(&tickslock);
80105b1f:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105b26:	e8 75 ea ff ff       	call   801045a0 <release>
80105b2b:	e9 1d ff ff ff       	jmp    80105a4d <trap+0x14d>
80105b30:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105b33:	8b 73 38             	mov    0x38(%ebx),%esi
80105b36:	e8 45 db ff ff       	call   80103680 <cpuid>
80105b3b:	89 7c 24 10          	mov    %edi,0x10(%esp)
80105b3f:	89 74 24 0c          	mov    %esi,0xc(%esp)
80105b43:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b47:	8b 43 30             	mov    0x30(%ebx),%eax
80105b4a:	c7 04 24 14 78 10 80 	movl   $0x80107814,(%esp)
80105b51:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b55:	e8 f6 aa ff ff       	call   80100650 <cprintf>
      panic("trap");
80105b5a:	c7 04 24 ea 77 10 80 	movl   $0x801077ea,(%esp)
80105b61:	e8 fa a7 ff ff       	call   80100360 <panic>
...
80105b7a:	74 14                	je     80105b90 <uartgetc+0x20>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
...
80105b84:	74 0a                	je     80105b90 <uartgetc+0x20>
80105b86:	b2 f8                	mov    $0xf8,%dl
80105b88:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105b89:	0f b6 c0             	movzbl %al,%eax
}
80105b8c:	5d                   	pop    %ebp
80105b8d:	c3                   	ret    
...
80105ba0 <uartputc>:
  if(!uart)
80105ba0:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
80105ba5:	85 c0                	test   %eax,%eax
80105ba7:	74 3f                	je     80105be8 <uartputc+0x48>
{
80105ba9:	55                   	push   %ebp
80105baa:	89 e5                	mov    %esp,%ebp
80105bac:	56                   	push   %esi
80105bad:	be fd 03 00 00       	mov    $0x3fd,%esi
80105bb2:	53                   	push   %ebx
  if(!uart)
80105bb3:	bb 80 00 00 00       	mov    $0x80,%ebx
{
80105bb8:	83 ec 10             	sub    $0x10,%esp
80105bbb:	eb 14                	jmp    80105bd1 <uartputc+0x31>
80105bbd:	8d 76 00             	lea    0x0(%esi),%esi
    microdelay(10);
80105bc0:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80105bc7:	e8 d4 cb ff ff       	call   801027a0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105bcc:	83 eb 01             	sub    $0x1,%ebx
80105bcf:	74 07                	je     80105bd8 <uartputc+0x38>
80105bd1:	89 f2                	mov    %esi,%edx
80105bd3:	ec                   	in     (%dx),%al
80105bd4:	a8 20                	test   $0x20,%al
80105bd6:	74 e8                	je     80105bc0 <uartputc+0x20>
  outb(COM1+0, c);
80105bd8:	0f b6 45 08          	movzbl 0x8(%ebp),%eax
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105bdc:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
80105c17:	b2 f8                	mov    $0xf8,%dl
80105c19:	ee                   	out    %al,(%dx)
80105c1a:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105c1f:	89 c8                	mov    %ecx,%eax
80105c21:	89 da                	mov    %ebx,%edx
80105c23:	ee                   	out    %al,(%dx)
80105c24:	b8 03 00 00 00       	mov    $0x3,%eax
80105c29:	89 f2                	mov    %esi,%edx
80105c2b:	ee                   	out    %al,(%dx)
80105c2c:	b2 fc                	mov    $0xfc,%dl
80105c2e:	89 c8                	mov    %ecx,%eax
80105c30:	ee                   	out    %al,(%dx)
80105c31:	b8 01 00 00 00       	mov    $0x1,%eax
80105c36:	89 da                	mov    %ebx,%edx
80105c38:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105c39:	b2 fd                	mov    $0xfd,%dl
80105c3b:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105c3c:	3c ff                	cmp    $0xff,%al
80105c3e:	74 42                	je     80105c82 <uartinit+0x92>
  uart = 1;
80105c40:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105c47:	00 00 00 
80105c4a:	89 fa                	mov    %edi,%edx
80105c4c:	ec                   	in     (%dx),%al
80105c4d:	b2 f8                	mov    $0xf8,%dl
80105c4f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105c50:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105c57:	00 
  for(p="xv6...\n"; *p; p++)
80105c58:	bb 0c 79 10 80       	mov    $0x8010790c,%ebx
  ioapicenable(IRQ_COM1, 0);
80105c5d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105c64:	e8 47 c6 ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105c69:	b8 78 00 00 00       	mov    $0x78,%eax
80105c6e:	66 90                	xchg   %ax,%ax
    uartputc(*p);
80105c70:	89 04 24             	mov    %eax,(%esp)
  for(p="xv6...\n"; *p; p++)
80105c73:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80105c76:	e8 25 ff ff ff       	call   80105ba0 <uartputc>
  for(p="xv6...\n"; *p; p++)
80105c7b:	0f be 03             	movsbl (%ebx),%eax
80105c7e:	84 c0                	test   %al,%al
80105c80:	75 ee                	jne    80105c70 <uartinit+0x80>
}
80105c82:	83 c4 1c             	add    $0x1c,%esp
80105c85:	5b                   	pop    %ebx
80105c86:	5e                   	pop    %esi
80105c87:	5f                   	pop    %edi
80105c88:	5d                   	pop    %ebp
...
80105c96:	c7 04 24 70 5b 10 80 	movl   $0x80105b70,(%esp)
80105c9d:	e8 0e ab ff ff       	call   801007b0 <consoleintr>
}
80105ca2:	c9                   	leave  
80105ca3:	c3                   	ret    
...
80105ca6:	6a 00                	push   $0x0
  jmp alltraps
80105ca8:	e9 5a fb ff ff       	jmp    80105807 <alltraps>
...
80105caf:	6a 01                	push   $0x1
  jmp alltraps
80105cb1:	e9 51 fb ff ff       	jmp    80105807 <alltraps>
...
80105cb8:	6a 02                	push   $0x2
  jmp alltraps
80105cba:	e9 48 fb ff ff       	jmp    80105807 <alltraps>
...
80105cc1:	6a 03                	push   $0x3
  jmp alltraps
80105cc3:	e9 3f fb ff ff       	jmp    80105807 <alltraps>
...
80105cca:	6a 04                	push   $0x4
  jmp alltraps
80105ccc:	e9 36 fb ff ff       	jmp    80105807 <alltraps>
...
80105cd1:	6a 00                	push   $0x0
  pushl $5
80105cd3:	6a 05                	push   $0x5
  jmp alltraps
80105cd5:	e9 2d fb ff ff       	jmp    80105807 <alltraps>
...
80105cda:	6a 00                	push   $0x0
  pushl $6
80105cdc:	6a 06                	push   $0x6
  jmp alltraps
80105cde:	e9 24 fb ff ff       	jmp    80105807 <alltraps>
...
80105ce3:	6a 00                	push   $0x0
  pushl $7
80105ce5:	6a 07                	push   $0x7
  jmp alltraps
80105ce7:	e9 1b fb ff ff       	jmp    80105807 <alltraps>
...
80105cec:	6a 08                	push   $0x8
  jmp alltraps
80105cee:	e9 14 fb ff ff       	jmp    80105807 <alltraps>
...
80105cf3:	6a 00                	push   $0x0
  pushl $9
80105cf5:	6a 09                	push   $0x9
  jmp alltraps
80105cf7:	e9 0b fb ff ff       	jmp    80105807 <alltraps>

80105cfc <vector10>:
.globl vector10
vector10:
  pushl $10
80105cfc:	6a 0a                	push   $0xa
  jmp alltraps
80105cfe:	e9 04 fb ff ff       	jmp    80105807 <alltraps>

80105d03 <vector11>:
.globl vector11
vector11:
  pushl $11
80105d03:	6a 0b                	push   $0xb
  jmp alltraps
80105d05:	e9 fd fa ff ff       	jmp    80105807 <alltraps>

80105d0a <vector12>:
.globl vector12
vector12:
  pushl $12
80105d0a:	6a 0c                	push   $0xc
  jmp alltraps
80105d0c:	e9 f6 fa ff ff       	jmp    80105807 <alltraps>

80105d11 <vector13>:
.globl vector13
vector13:
  pushl $13
80105d11:	6a 0d                	push   $0xd
  jmp alltraps
80105d13:	e9 ef fa ff ff       	jmp    80105807 <alltraps>

80105d18 <vector14>:
.globl vector14
vector14:
  pushl $14
80105d18:	6a 0e                	push   $0xe
  jmp alltraps
80105d1a:	e9 e8 fa ff ff       	jmp    80105807 <alltraps>
...
80105d1f:	6a 00                	push   $0x0
  pushl $15
80105d21:	6a 0f                	push   $0xf
  jmp alltraps
80105d23:	e9 df fa ff ff       	jmp    80105807 <alltraps>
...
80105d28:	6a 00                	push   $0x0
  pushl $16
80105d2a:	6a 10                	push   $0x10
  jmp alltraps
80105d2c:	e9 d6 fa ff ff       	jmp    80105807 <alltraps>

80105d31 <vector17>:
.globl vector17
vector17:
  pushl $17
80105d31:	6a 11                	push   $0x11
  jmp alltraps
80105d33:	e9 cf fa ff ff       	jmp    80105807 <alltraps>
...
80105d38:	6a 00                	push   $0x0
  pushl $18
80105d3a:	6a 12                	push   $0x12
  jmp alltraps
80105d3c:	e9 c6 fa ff ff       	jmp    80105807 <alltraps>
...
80105d41:	6a 00                	push   $0x0
  pushl $19
80105d43:	6a 13                	push   $0x13
  jmp alltraps
80105d45:	e9 bd fa ff ff       	jmp    80105807 <alltraps>
...
80105d4a:	6a 00                	push   $0x0
  pushl $20
80105d4c:	6a 14                	push   $0x14
  jmp alltraps
80105d4e:	e9 b4 fa ff ff       	jmp    80105807 <alltraps>
...
80105d53:	6a 00                	push   $0x0
  pushl $21
80105d55:	6a 15                	push   $0x15
  jmp alltraps
80105d57:	e9 ab fa ff ff       	jmp    80105807 <alltraps>
...
80105d5c:	6a 00                	push   $0x0
  pushl $22
80105d5e:	6a 16                	push   $0x16
  jmp alltraps
80105d60:	e9 a2 fa ff ff       	jmp    80105807 <alltraps>
...
80105d65:	6a 00                	push   $0x0
  pushl $23
80105d67:	6a 17                	push   $0x17
  jmp alltraps
80105d69:	e9 99 fa ff ff       	jmp    80105807 <alltraps>
...
80105d6e:	6a 00                	push   $0x0
  pushl $24
80105d70:	6a 18                	push   $0x18
  jmp alltraps
80105d72:	e9 90 fa ff ff       	jmp    80105807 <alltraps>
...
80105d77:	6a 00                	push   $0x0
  pushl $25
80105d79:	6a 19                	push   $0x19
  jmp alltraps
80105d7b:	e9 87 fa ff ff       	jmp    80105807 <alltraps>
...
80105d80:	6a 00                	push   $0x0
  pushl $26
80105d82:	6a 1a                	push   $0x1a
  jmp alltraps
80105d84:	e9 7e fa ff ff       	jmp    80105807 <alltraps>
...
80105d89:	6a 00                	push   $0x0
  pushl $27
80105d8b:	6a 1b                	push   $0x1b
  jmp alltraps
80105d8d:	e9 75 fa ff ff       	jmp    80105807 <alltraps>
...
80105d92:	6a 00                	push   $0x0
  pushl $28
80105d94:	6a 1c                	push   $0x1c
  jmp alltraps
80105d96:	e9 6c fa ff ff       	jmp    80105807 <alltraps>
...
80105d9b:	6a 00                	push   $0x0
  pushl $29
80105d9d:	6a 1d                	push   $0x1d
  jmp alltraps
80105d9f:	e9 63 fa ff ff       	jmp    80105807 <alltraps>
...
80105da4:	6a 00                	push   $0x0
  pushl $30
80105da6:	6a 1e                	push   $0x1e
  jmp alltraps
80105da8:	e9 5a fa ff ff       	jmp    80105807 <alltraps>
...
80105dad:	6a 00                	push   $0x0
  pushl $31
80105daf:	6a 1f                	push   $0x1f
  jmp alltraps
80105db1:	e9 51 fa ff ff       	jmp    80105807 <alltraps>
...
80105db6:	6a 00                	push   $0x0
  pushl $32
80105db8:	6a 20                	push   $0x20
  jmp alltraps
80105dba:	e9 48 fa ff ff       	jmp    80105807 <alltraps>
...
80105dbf:	6a 00                	push   $0x0
  pushl $33
80105dc1:	6a 21                	push   $0x21
  jmp alltraps
80105dc3:	e9 3f fa ff ff       	jmp    80105807 <alltraps>
...
80105dc8:	6a 00                	push   $0x0
  pushl $34
80105dca:	6a 22                	push   $0x22
  jmp alltraps
80105dcc:	e9 36 fa ff ff       	jmp    80105807 <alltraps>
...
80105dd1:	6a 00                	push   $0x0
  pushl $35
80105dd3:	6a 23                	push   $0x23
  jmp alltraps
80105dd5:	e9 2d fa ff ff       	jmp    80105807 <alltraps>
...
80105dda:	6a 00                	push   $0x0
  pushl $36
80105ddc:	6a 24                	push   $0x24
  jmp alltraps
80105dde:	e9 24 fa ff ff       	jmp    80105807 <alltraps>
...
80105de3:	6a 00                	push   $0x0
  pushl $37
80105de5:	6a 25                	push   $0x25
  jmp alltraps
80105de7:	e9 1b fa ff ff       	jmp    80105807 <alltraps>
...
80105dec:	6a 00                	push   $0x0
  pushl $38
80105dee:	6a 26                	push   $0x26
  jmp alltraps
80105df0:	e9 12 fa ff ff       	jmp    80105807 <alltraps>
...
80105df5:	6a 00                	push   $0x0
  pushl $39
80105df7:	6a 27                	push   $0x27
  jmp alltraps
80105df9:	e9 09 fa ff ff       	jmp    80105807 <alltraps>
...
80105dfe:	6a 00                	push   $0x0
  pushl $40
80105e00:	6a 28                	push   $0x28
  jmp alltraps
80105e02:	e9 00 fa ff ff       	jmp    80105807 <alltraps>
...
80105e07:	6a 00                	push   $0x0
  pushl $41
80105e09:	6a 29                	push   $0x29
  jmp alltraps
80105e0b:	e9 f7 f9 ff ff       	jmp    80105807 <alltraps>
...
80105e10:	6a 00                	push   $0x0
  pushl $42
80105e12:	6a 2a                	push   $0x2a
  jmp alltraps
80105e14:	e9 ee f9 ff ff       	jmp    80105807 <alltraps>
...
80105e19:	6a 00                	push   $0x0
  pushl $43
80105e1b:	6a 2b                	push   $0x2b
  jmp alltraps
80105e1d:	e9 e5 f9 ff ff       	jmp    80105807 <alltraps>
...
80105e22:	6a 00                	push   $0x0
  pushl $44
80105e24:	6a 2c                	push   $0x2c
  jmp alltraps
80105e26:	e9 dc f9 ff ff       	jmp    80105807 <alltraps>
...
80105e2b:	6a 00                	push   $0x0
  pushl $45
80105e2d:	6a 2d                	push   $0x2d
  jmp alltraps
80105e2f:	e9 d3 f9 ff ff       	jmp    80105807 <alltraps>
...
80105e34:	6a 00                	push   $0x0
  pushl $46
80105e36:	6a 2e                	push   $0x2e
  jmp alltraps
80105e38:	e9 ca f9 ff ff       	jmp    80105807 <alltraps>
...
80105e3d:	6a 00                	push   $0x0
  pushl $47
80105e3f:	6a 2f                	push   $0x2f
  jmp alltraps
80105e41:	e9 c1 f9 ff ff       	jmp    80105807 <alltraps>
...
80105e46:	6a 00                	push   $0x0
  pushl $48
80105e48:	6a 30                	push   $0x30
  jmp alltraps
80105e4a:	e9 b8 f9 ff ff       	jmp    80105807 <alltraps>
...
80105e4f:	6a 00                	push   $0x0
  pushl $49
80105e51:	6a 31                	push   $0x31
  jmp alltraps
80105e53:	e9 af f9 ff ff       	jmp    80105807 <alltraps>
...
80105e58:	6a 00                	push   $0x0
  pushl $50
80105e5a:	6a 32                	push   $0x32
  jmp alltraps
80105e5c:	e9 a6 f9 ff ff       	jmp    80105807 <alltraps>
...
80105e61:	6a 00                	push   $0x0
  pushl $51
80105e63:	6a 33                	push   $0x33
  jmp alltraps
80105e65:	e9 9d f9 ff ff       	jmp    80105807 <alltraps>
...
80105e6a:	6a 00                	push   $0x0
  pushl $52
80105e6c:	6a 34                	push   $0x34
  jmp alltraps
80105e6e:	e9 94 f9 ff ff       	jmp    80105807 <alltraps>
...
80105e73:	6a 00                	push   $0x0
  pushl $53
80105e75:	6a 35                	push   $0x35
  jmp alltraps
80105e77:	e9 8b f9 ff ff       	jmp    80105807 <alltraps>
...
80105e7c:	6a 00                	push   $0x0
  pushl $54
80105e7e:	6a 36                	push   $0x36
  jmp alltraps
80105e80:	e9 82 f9 ff ff       	jmp    80105807 <alltraps>
...
80105e85:	6a 00                	push   $0x0
  pushl $55
80105e87:	6a 37                	push   $0x37
  jmp alltraps
80105e89:	e9 79 f9 ff ff       	jmp    80105807 <alltraps>
...
80105e8e:	6a 00                	push   $0x0
  pushl $56
80105e90:	6a 38                	push   $0x38
  jmp alltraps
80105e92:	e9 70 f9 ff ff       	jmp    80105807 <alltraps>
...
80105e97:	6a 00                	push   $0x0
  pushl $57
80105e99:	6a 39                	push   $0x39
  jmp alltraps
80105e9b:	e9 67 f9 ff ff       	jmp    80105807 <alltraps>
...
80105ea0:	6a 00                	push   $0x0
  pushl $58
80105ea2:	6a 3a                	push   $0x3a
  jmp alltraps
80105ea4:	e9 5e f9 ff ff       	jmp    80105807 <alltraps>
...
80105ea9:	6a 00                	push   $0x0
  pushl $59
80105eab:	6a 3b                	push   $0x3b
  jmp alltraps
80105ead:	e9 55 f9 ff ff       	jmp    80105807 <alltraps>
...
80105eb2:	6a 00                	push   $0x0
  pushl $60
80105eb4:	6a 3c                	push   $0x3c
  jmp alltraps
80105eb6:	e9 4c f9 ff ff       	jmp    80105807 <alltraps>
...
80105ebb:	6a 00                	push   $0x0
  pushl $61
80105ebd:	6a 3d                	push   $0x3d
  jmp alltraps
80105ebf:	e9 43 f9 ff ff       	jmp    80105807 <alltraps>
...
80105ec4:	6a 00                	push   $0x0
  pushl $62
80105ec6:	6a 3e                	push   $0x3e
  jmp alltraps
80105ec8:	e9 3a f9 ff ff       	jmp    80105807 <alltraps>
...
80105ecd:	6a 00                	push   $0x0
  pushl $63
80105ecf:	6a 3f                	push   $0x3f
  jmp alltraps
80105ed1:	e9 31 f9 ff ff       	jmp    80105807 <alltraps>
...
80105ed6:	6a 00                	push   $0x0
  pushl $64
80105ed8:	6a 40                	push   $0x40
  jmp alltraps
80105eda:	e9 28 f9 ff ff       	jmp    80105807 <alltraps>
...
80105edf:	6a 00                	push   $0x0
  pushl $65
80105ee1:	6a 41                	push   $0x41
  jmp alltraps
80105ee3:	e9 1f f9 ff ff       	jmp    80105807 <alltraps>
...
80105ee8:	6a 00                	push   $0x0
  pushl $66
80105eea:	6a 42                	push   $0x42
  jmp alltraps
80105eec:	e9 16 f9 ff ff       	jmp    80105807 <alltraps>
...
80105ef1:	6a 00                	push   $0x0
  pushl $67
80105ef3:	6a 43                	push   $0x43
  jmp alltraps
80105ef5:	e9 0d f9 ff ff       	jmp    80105807 <alltraps>
...
80105efa:	6a 00                	push   $0x0
  pushl $68
80105efc:	6a 44                	push   $0x44
  jmp alltraps
80105efe:	e9 04 f9 ff ff       	jmp    80105807 <alltraps>
...
80105f03:	6a 00                	push   $0x0
  pushl $69
80105f05:	6a 45                	push   $0x45
  jmp alltraps
80105f07:	e9 fb f8 ff ff       	jmp    80105807 <alltraps>
...
80105f0c:	6a 00                	push   $0x0
  pushl $70
80105f0e:	6a 46                	push   $0x46
  jmp alltraps
80105f10:	e9 f2 f8 ff ff       	jmp    80105807 <alltraps>
...
80105f15:	6a 00                	push   $0x0
  pushl $71
80105f17:	6a 47                	push   $0x47
  jmp alltraps
80105f19:	e9 e9 f8 ff ff       	jmp    80105807 <alltraps>
...
80105f1e:	6a 00                	push   $0x0
  pushl $72
80105f20:	6a 48                	push   $0x48
  jmp alltraps
80105f22:	e9 e0 f8 ff ff       	jmp    80105807 <alltraps>
...
80105f27:	6a 00                	push   $0x0
  pushl $73
80105f29:	6a 49                	push   $0x49
  jmp alltraps
80105f2b:	e9 d7 f8 ff ff       	jmp    80105807 <alltraps>
...
80105f30:	6a 00                	push   $0x0
  pushl $74
80105f32:	6a 4a                	push   $0x4a
  jmp alltraps
80105f34:	e9 ce f8 ff ff       	jmp    80105807 <alltraps>
...
80105f39:	6a 00                	push   $0x0
  pushl $75
80105f3b:	6a 4b                	push   $0x4b
  jmp alltraps
80105f3d:	e9 c5 f8 ff ff       	jmp    80105807 <alltraps>
...
80105f42:	6a 00                	push   $0x0
  pushl $76
80105f44:	6a 4c                	push   $0x4c
  jmp alltraps
80105f46:	e9 bc f8 ff ff       	jmp    80105807 <alltraps>
...
80105f4b:	6a 00                	push   $0x0
  pushl $77
80105f4d:	6a 4d                	push   $0x4d
  jmp alltraps
80105f4f:	e9 b3 f8 ff ff       	jmp    80105807 <alltraps>
...
80105f54:	6a 00                	push   $0x0
  pushl $78
80105f56:	6a 4e                	push   $0x4e
  jmp alltraps
80105f58:	e9 aa f8 ff ff       	jmp    80105807 <alltraps>
...
80105f5d:	6a 00                	push   $0x0
  pushl $79
80105f5f:	6a 4f                	push   $0x4f
  jmp alltraps
80105f61:	e9 a1 f8 ff ff       	jmp    80105807 <alltraps>
...
80105f66:	6a 00                	push   $0x0
  pushl $80
80105f68:	6a 50                	push   $0x50
  jmp alltraps
80105f6a:	e9 98 f8 ff ff       	jmp    80105807 <alltraps>
...
80105f6f:	6a 00                	push   $0x0
  pushl $81
80105f71:	6a 51                	push   $0x51
  jmp alltraps
80105f73:	e9 8f f8 ff ff       	jmp    80105807 <alltraps>
...
80105f78:	6a 00                	push   $0x0
  pushl $82
80105f7a:	6a 52                	push   $0x52
  jmp alltraps
80105f7c:	e9 86 f8 ff ff       	jmp    80105807 <alltraps>
...
80105f81:	6a 00                	push   $0x0
  pushl $83
80105f83:	6a 53                	push   $0x53
  jmp alltraps
80105f85:	e9 7d f8 ff ff       	jmp    80105807 <alltraps>
...
80105f8a:	6a 00                	push   $0x0
  pushl $84
80105f8c:	6a 54                	push   $0x54
  jmp alltraps
80105f8e:	e9 74 f8 ff ff       	jmp    80105807 <alltraps>
...
80105f93:	6a 00                	push   $0x0
  pushl $85
80105f95:	6a 55                	push   $0x55
  jmp alltraps
80105f97:	e9 6b f8 ff ff       	jmp    80105807 <alltraps>
...
80105f9c:	6a 00                	push   $0x0
  pushl $86
80105f9e:	6a 56                	push   $0x56
  jmp alltraps
80105fa0:	e9 62 f8 ff ff       	jmp    80105807 <alltraps>
...
80105fa5:	6a 00                	push   $0x0
  pushl $87
80105fa7:	6a 57                	push   $0x57
  jmp alltraps
80105fa9:	e9 59 f8 ff ff       	jmp    80105807 <alltraps>
...
80105fae:	6a 00                	push   $0x0
  pushl $88
80105fb0:	6a 58                	push   $0x58
  jmp alltraps
80105fb2:	e9 50 f8 ff ff       	jmp    80105807 <alltraps>
...
80105fb7:	6a 00                	push   $0x0
  pushl $89
80105fb9:	6a 59                	push   $0x59
  jmp alltraps
80105fbb:	e9 47 f8 ff ff       	jmp    80105807 <alltraps>
...
80105fc0:	6a 00                	push   $0x0
  pushl $90
80105fc2:	6a 5a                	push   $0x5a
  jmp alltraps
80105fc4:	e9 3e f8 ff ff       	jmp    80105807 <alltraps>
...
80105fc9:	6a 00                	push   $0x0
  pushl $91
80105fcb:	6a 5b                	push   $0x5b
  jmp alltraps
80105fcd:	e9 35 f8 ff ff       	jmp    80105807 <alltraps>
...
80105fd2:	6a 00                	push   $0x0
  pushl $92
80105fd4:	6a 5c                	push   $0x5c
  jmp alltraps
80105fd6:	e9 2c f8 ff ff       	jmp    80105807 <alltraps>
...
80105fdb:	6a 00                	push   $0x0
  pushl $93
80105fdd:	6a 5d                	push   $0x5d
  jmp alltraps
80105fdf:	e9 23 f8 ff ff       	jmp    80105807 <alltraps>
...
80105fe4:	6a 00                	push   $0x0
  pushl $94
80105fe6:	6a 5e                	push   $0x5e
  jmp alltraps
80105fe8:	e9 1a f8 ff ff       	jmp    80105807 <alltraps>
...
80105fed:	6a 00                	push   $0x0
  pushl $95
80105fef:	6a 5f                	push   $0x5f
  jmp alltraps
80105ff1:	e9 11 f8 ff ff       	jmp    80105807 <alltraps>
...
80105ff6:	6a 00                	push   $0x0
  pushl $96
80105ff8:	6a 60                	push   $0x60
  jmp alltraps
80105ffa:	e9 08 f8 ff ff       	jmp    80105807 <alltraps>
...
80105fff:	6a 00                	push   $0x0
  pushl $97
80106001:	6a 61                	push   $0x61
  jmp alltraps
80106003:	e9 ff f7 ff ff       	jmp    80105807 <alltraps>
...
80106008:	6a 00                	push   $0x0
  pushl $98
8010600a:	6a 62                	push   $0x62
  jmp alltraps
8010600c:	e9 f6 f7 ff ff       	jmp    80105807 <alltraps>
...
80106011:	6a 00                	push   $0x0
  pushl $99
80106013:	6a 63                	push   $0x63
  jmp alltraps
80106015:	e9 ed f7 ff ff       	jmp    80105807 <alltraps>
...
8010601a:	6a 00                	push   $0x0
  pushl $100
8010601c:	6a 64                	push   $0x64
  jmp alltraps
8010601e:	e9 e4 f7 ff ff       	jmp    80105807 <alltraps>
...
80106023:	6a 00                	push   $0x0
  pushl $101
80106025:	6a 65                	push   $0x65
  jmp alltraps
80106027:	e9 db f7 ff ff       	jmp    80105807 <alltraps>
...
8010602c:	6a 00                	push   $0x0
  pushl $102
8010602e:	6a 66                	push   $0x66
  jmp alltraps
80106030:	e9 d2 f7 ff ff       	jmp    80105807 <alltraps>
...
80106035:	6a 00                	push   $0x0
  pushl $103
80106037:	6a 67                	push   $0x67
  jmp alltraps
80106039:	e9 c9 f7 ff ff       	jmp    80105807 <alltraps>
...
8010603e:	6a 00                	push   $0x0
  pushl $104
80106040:	6a 68                	push   $0x68
  jmp alltraps
80106042:	e9 c0 f7 ff ff       	jmp    80105807 <alltraps>
...
80106047:	6a 00                	push   $0x0
  pushl $105
80106049:	6a 69                	push   $0x69
  jmp alltraps
8010604b:	e9 b7 f7 ff ff       	jmp    80105807 <alltraps>
...
80106050:	6a 00                	push   $0x0
  pushl $106
80106052:	6a 6a                	push   $0x6a
  jmp alltraps
80106054:	e9 ae f7 ff ff       	jmp    80105807 <alltraps>
...
80106059:	6a 00                	push   $0x0
  pushl $107
8010605b:	6a 6b                	push   $0x6b
  jmp alltraps
8010605d:	e9 a5 f7 ff ff       	jmp    80105807 <alltraps>
...
80106062:	6a 00                	push   $0x0
  pushl $108
80106064:	6a 6c                	push   $0x6c
  jmp alltraps
80106066:	e9 9c f7 ff ff       	jmp    80105807 <alltraps>
...
8010606b:	6a 00                	push   $0x0
  pushl $109
8010606d:	6a 6d                	push   $0x6d
  jmp alltraps
8010606f:	e9 93 f7 ff ff       	jmp    80105807 <alltraps>
...
80106074:	6a 00                	push   $0x0
  pushl $110
80106076:	6a 6e                	push   $0x6e
  jmp alltraps
80106078:	e9 8a f7 ff ff       	jmp    80105807 <alltraps>
...
8010607d:	6a 00                	push   $0x0
  pushl $111
8010607f:	6a 6f                	push   $0x6f
  jmp alltraps
80106081:	e9 81 f7 ff ff       	jmp    80105807 <alltraps>
...
80106086:	6a 00                	push   $0x0
  pushl $112
80106088:	6a 70                	push   $0x70
  jmp alltraps
8010608a:	e9 78 f7 ff ff       	jmp    80105807 <alltraps>
...
8010608f:	6a 00                	push   $0x0
  pushl $113
80106091:	6a 71                	push   $0x71
  jmp alltraps
80106093:	e9 6f f7 ff ff       	jmp    80105807 <alltraps>
...
80106098:	6a 00                	push   $0x0
  pushl $114
8010609a:	6a 72                	push   $0x72
  jmp alltraps
8010609c:	e9 66 f7 ff ff       	jmp    80105807 <alltraps>
...
801060a1:	6a 00                	push   $0x0
  pushl $115
801060a3:	6a 73                	push   $0x73
  jmp alltraps
801060a5:	e9 5d f7 ff ff       	jmp    80105807 <alltraps>
...
801060aa:	6a 00                	push   $0x0
  pushl $116
801060ac:	6a 74                	push   $0x74
  jmp alltraps
801060ae:	e9 54 f7 ff ff       	jmp    80105807 <alltraps>
...
801060b3:	6a 00                	push   $0x0
  pushl $117
801060b5:	6a 75                	push   $0x75
  jmp alltraps
801060b7:	e9 4b f7 ff ff       	jmp    80105807 <alltraps>
...
801060bc:	6a 00                	push   $0x0
  pushl $118
801060be:	6a 76                	push   $0x76
  jmp alltraps
801060c0:	e9 42 f7 ff ff       	jmp    80105807 <alltraps>
...
801060c5:	6a 00                	push   $0x0
  pushl $119
801060c7:	6a 77                	push   $0x77
  jmp alltraps
801060c9:	e9 39 f7 ff ff       	jmp    80105807 <alltraps>
...
801060ce:	6a 00                	push   $0x0
  pushl $120
801060d0:	6a 78                	push   $0x78
  jmp alltraps
801060d2:	e9 30 f7 ff ff       	jmp    80105807 <alltraps>
...
801060d7:	6a 00                	push   $0x0
  pushl $121
801060d9:	6a 79                	push   $0x79
  jmp alltraps
801060db:	e9 27 f7 ff ff       	jmp    80105807 <alltraps>
...
801060e0:	6a 00                	push   $0x0
  pushl $122
801060e2:	6a 7a                	push   $0x7a
  jmp alltraps
801060e4:	e9 1e f7 ff ff       	jmp    80105807 <alltraps>
...
801060e9:	6a 00                	push   $0x0
  pushl $123
801060eb:	6a 7b                	push   $0x7b
  jmp alltraps
801060ed:	e9 15 f7 ff ff       	jmp    80105807 <alltraps>
...
801060f2:	6a 00                	push   $0x0
  pushl $124
801060f4:	6a 7c                	push   $0x7c
  jmp alltraps
801060f6:	e9 0c f7 ff ff       	jmp    80105807 <alltraps>
...
801060fb:	6a 00                	push   $0x0
  pushl $125
801060fd:	6a 7d                	push   $0x7d
  jmp alltraps
801060ff:	e9 03 f7 ff ff       	jmp    80105807 <alltraps>
...
80106104:	6a 00                	push   $0x0
  pushl $126
80106106:	6a 7e                	push   $0x7e
  jmp alltraps
80106108:	e9 fa f6 ff ff       	jmp    80105807 <alltraps>
...
8010610d:	6a 00                	push   $0x0
  pushl $127
8010610f:	6a 7f                	push   $0x7f
  jmp alltraps
80106111:	e9 f1 f6 ff ff       	jmp    80105807 <alltraps>
...
80106118:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010611d:	e9 e5 f6 ff ff       	jmp    80105807 <alltraps>
...
80106122:	6a 00                	push   $0x0
  pushl $129
80106124:	68 81 00 00 00       	push   $0x81
  jmp alltraps
...
8010612e:	6a 00                	push   $0x0
  pushl $130
80106130:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106135:	e9 cd f6 ff ff       	jmp    80105807 <alltraps>
...
8010613a:	6a 00                	push   $0x0
  pushl $131
8010613c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106141:	e9 c1 f6 ff ff       	jmp    80105807 <alltraps>
...
80106146:	6a 00                	push   $0x0
  pushl $132
80106148:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010614d:	e9 b5 f6 ff ff       	jmp    80105807 <alltraps>
...
80106152:	6a 00                	push   $0x0
  pushl $133
80106154:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106159:	e9 a9 f6 ff ff       	jmp    80105807 <alltraps>
...
8010615e:	6a 00                	push   $0x0
  pushl $134
80106160:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106165:	e9 9d f6 ff ff       	jmp    80105807 <alltraps>
...
8010616a:	6a 00                	push   $0x0
  pushl $135
8010616c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106171:	e9 91 f6 ff ff       	jmp    80105807 <alltraps>
...
80106176:	6a 00                	push   $0x0
  pushl $136
80106178:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010617d:	e9 85 f6 ff ff       	jmp    80105807 <alltraps>
...
80106182:	6a 00                	push   $0x0
  pushl $137
80106184:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106189:	e9 79 f6 ff ff       	jmp    80105807 <alltraps>
...
8010618e:	6a 00                	push   $0x0
  pushl $138
80106190:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106195:	e9 6d f6 ff ff       	jmp    80105807 <alltraps>
...
8010619a:	6a 00                	push   $0x0
  pushl $139
8010619c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801061a1:	e9 61 f6 ff ff       	jmp    80105807 <alltraps>
...
801061a6:	6a 00                	push   $0x0
  pushl $140
801061a8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801061ad:	e9 55 f6 ff ff       	jmp    80105807 <alltraps>
...
801061b2:	6a 00                	push   $0x0
  pushl $141
801061b4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801061b9:	e9 49 f6 ff ff       	jmp    80105807 <alltraps>
...
801061be:	6a 00                	push   $0x0
  pushl $142
801061c0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801061c5:	e9 3d f6 ff ff       	jmp    80105807 <alltraps>
...
801061ca:	6a 00                	push   $0x0
  pushl $143
801061cc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801061d1:	e9 31 f6 ff ff       	jmp    80105807 <alltraps>
...
801061d6:	6a 00                	push   $0x0
  pushl $144
801061d8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801061dd:	e9 25 f6 ff ff       	jmp    80105807 <alltraps>
...
801061e2:	6a 00                	push   $0x0
  pushl $145
801061e4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801061e9:	e9 19 f6 ff ff       	jmp    80105807 <alltraps>
...
801061ee:	6a 00                	push   $0x0
  pushl $146
801061f0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801061f5:	e9 0d f6 ff ff       	jmp    80105807 <alltraps>
...
801061fa:	6a 00                	push   $0x0
  pushl $147
801061fc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106201:	e9 01 f6 ff ff       	jmp    80105807 <alltraps>
...
80106206:	6a 00                	push   $0x0
  pushl $148
80106208:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010620d:	e9 f5 f5 ff ff       	jmp    80105807 <alltraps>
...
80106212:	6a 00                	push   $0x0
  pushl $149
80106214:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106219:	e9 e9 f5 ff ff       	jmp    80105807 <alltraps>
...
8010621e:	6a 00                	push   $0x0
  pushl $150
80106220:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106225:	e9 dd f5 ff ff       	jmp    80105807 <alltraps>
...
8010622a:	6a 00                	push   $0x0
  pushl $151
8010622c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106231:	e9 d1 f5 ff ff       	jmp    80105807 <alltraps>
...
80106236:	6a 00                	push   $0x0
  pushl $152
80106238:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010623d:	e9 c5 f5 ff ff       	jmp    80105807 <alltraps>
...
80106242:	6a 00                	push   $0x0
  pushl $153
80106244:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106249:	e9 b9 f5 ff ff       	jmp    80105807 <alltraps>
...
8010624e:	6a 00                	push   $0x0
  pushl $154
80106250:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106255:	e9 ad f5 ff ff       	jmp    80105807 <alltraps>
...
8010625a:	6a 00                	push   $0x0
  pushl $155
8010625c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106261:	e9 a1 f5 ff ff       	jmp    80105807 <alltraps>
...
80106266:	6a 00                	push   $0x0
  pushl $156
80106268:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010626d:	e9 95 f5 ff ff       	jmp    80105807 <alltraps>
...
80106272:	6a 00                	push   $0x0
  pushl $157
80106274:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106279:	e9 89 f5 ff ff       	jmp    80105807 <alltraps>
...
8010627e:	6a 00                	push   $0x0
  pushl $158
80106280:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106285:	e9 7d f5 ff ff       	jmp    80105807 <alltraps>
...
8010628a:	6a 00                	push   $0x0
  pushl $159
8010628c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106291:	e9 71 f5 ff ff       	jmp    80105807 <alltraps>
...
80106296:	6a 00                	push   $0x0
  pushl $160
80106298:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010629d:	e9 65 f5 ff ff       	jmp    80105807 <alltraps>
...
801062a2:	6a 00                	push   $0x0
  pushl $161
801062a4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801062a9:	e9 59 f5 ff ff       	jmp    80105807 <alltraps>
...
801062ae:	6a 00                	push   $0x0
  pushl $162
801062b0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801062b5:	e9 4d f5 ff ff       	jmp    80105807 <alltraps>
...
801062ba:	6a 00                	push   $0x0
  pushl $163
801062bc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801062c1:	e9 41 f5 ff ff       	jmp    80105807 <alltraps>
...
801062c6:	6a 00                	push   $0x0
  pushl $164
801062c8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801062cd:	e9 35 f5 ff ff       	jmp    80105807 <alltraps>
...
801062d2:	6a 00                	push   $0x0
  pushl $165
801062d4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801062d9:	e9 29 f5 ff ff       	jmp    80105807 <alltraps>
...
801062de:	6a 00                	push   $0x0
  pushl $166
801062e0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801062e5:	e9 1d f5 ff ff       	jmp    80105807 <alltraps>
...
801062ea:	6a 00                	push   $0x0
  pushl $167
801062ec:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801062f1:	e9 11 f5 ff ff       	jmp    80105807 <alltraps>
...
801062f6:	6a 00                	push   $0x0
  pushl $168
801062f8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801062fd:	e9 05 f5 ff ff       	jmp    80105807 <alltraps>
...
80106302:	6a 00                	push   $0x0
  pushl $169
80106304:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106309:	e9 f9 f4 ff ff       	jmp    80105807 <alltraps>
...
8010630e:	6a 00                	push   $0x0
  pushl $170
80106310:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106315:	e9 ed f4 ff ff       	jmp    80105807 <alltraps>
...
8010631a:	6a 00                	push   $0x0
  pushl $171
8010631c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106321:	e9 e1 f4 ff ff       	jmp    80105807 <alltraps>
...
80106326:	6a 00                	push   $0x0
  pushl $172
80106328:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010632d:	e9 d5 f4 ff ff       	jmp    80105807 <alltraps>
...
80106332:	6a 00                	push   $0x0
  pushl $173
80106334:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106339:	e9 c9 f4 ff ff       	jmp    80105807 <alltraps>
...
8010633e:	6a 00                	push   $0x0
  pushl $174
80106340:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106345:	e9 bd f4 ff ff       	jmp    80105807 <alltraps>
...
8010634a:	6a 00                	push   $0x0
  pushl $175
8010634c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106351:	e9 b1 f4 ff ff       	jmp    80105807 <alltraps>
...
80106356:	6a 00                	push   $0x0
  pushl $176
80106358:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010635d:	e9 a5 f4 ff ff       	jmp    80105807 <alltraps>
...
80106362:	6a 00                	push   $0x0
  pushl $177
80106364:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106369:	e9 99 f4 ff ff       	jmp    80105807 <alltraps>
...
8010636e:	6a 00                	push   $0x0
  pushl $178
80106370:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106375:	e9 8d f4 ff ff       	jmp    80105807 <alltraps>
...
8010637a:	6a 00                	push   $0x0
  pushl $179
8010637c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106381:	e9 81 f4 ff ff       	jmp    80105807 <alltraps>
...
80106386:	6a 00                	push   $0x0
  pushl $180
80106388:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010638d:	e9 75 f4 ff ff       	jmp    80105807 <alltraps>
...
80106392:	6a 00                	push   $0x0
  pushl $181
80106394:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106399:	e9 69 f4 ff ff       	jmp    80105807 <alltraps>
...
8010639e:	6a 00                	push   $0x0
  pushl $182
801063a0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801063a5:	e9 5d f4 ff ff       	jmp    80105807 <alltraps>
...
801063aa:	6a 00                	push   $0x0
  pushl $183
801063ac:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801063b1:	e9 51 f4 ff ff       	jmp    80105807 <alltraps>
...
801063b6:	6a 00                	push   $0x0
  pushl $184
801063b8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801063bd:	e9 45 f4 ff ff       	jmp    80105807 <alltraps>
...
801063c2:	6a 00                	push   $0x0
  pushl $185
801063c4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801063c9:	e9 39 f4 ff ff       	jmp    80105807 <alltraps>
...
801063ce:	6a 00                	push   $0x0
  pushl $186
801063d0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801063d5:	e9 2d f4 ff ff       	jmp    80105807 <alltraps>
...
801063da:	6a 00                	push   $0x0
  pushl $187
801063dc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801063e1:	e9 21 f4 ff ff       	jmp    80105807 <alltraps>
...
801063e6:	6a 00                	push   $0x0
  pushl $188
801063e8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801063ed:	e9 15 f4 ff ff       	jmp    80105807 <alltraps>
...
801063f2:	6a 00                	push   $0x0
  pushl $189
801063f4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801063f9:	e9 09 f4 ff ff       	jmp    80105807 <alltraps>
...
801063fe:	6a 00                	push   $0x0
  pushl $190
80106400:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106405:	e9 fd f3 ff ff       	jmp    80105807 <alltraps>
...
8010640a:	6a 00                	push   $0x0
  pushl $191
8010640c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106411:	e9 f1 f3 ff ff       	jmp    80105807 <alltraps>
...
80106416:	6a 00                	push   $0x0
  pushl $192
80106418:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010641d:	e9 e5 f3 ff ff       	jmp    80105807 <alltraps>
...
80106422:	6a 00                	push   $0x0
  pushl $193
80106424:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106429:	e9 d9 f3 ff ff       	jmp    80105807 <alltraps>
...
8010642e:	6a 00                	push   $0x0
  pushl $194
80106430:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106435:	e9 cd f3 ff ff       	jmp    80105807 <alltraps>
...
8010643a:	6a 00                	push   $0x0
  pushl $195
8010643c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106441:	e9 c1 f3 ff ff       	jmp    80105807 <alltraps>
...
80106446:	6a 00                	push   $0x0
  pushl $196
80106448:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010644d:	e9 b5 f3 ff ff       	jmp    80105807 <alltraps>
...
80106452:	6a 00                	push   $0x0
  pushl $197
80106454:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106459:	e9 a9 f3 ff ff       	jmp    80105807 <alltraps>
...
8010645e:	6a 00                	push   $0x0
  pushl $198
80106460:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106465:	e9 9d f3 ff ff       	jmp    80105807 <alltraps>
...
8010646a:	6a 00                	push   $0x0
  pushl $199
8010646c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106471:	e9 91 f3 ff ff       	jmp    80105807 <alltraps>
...
80106476:	6a 00                	push   $0x0
  pushl $200
80106478:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010647d:	e9 85 f3 ff ff       	jmp    80105807 <alltraps>
...
80106482:	6a 00                	push   $0x0
  pushl $201
80106484:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106489:	e9 79 f3 ff ff       	jmp    80105807 <alltraps>
...
8010648e:	6a 00                	push   $0x0
  pushl $202
80106490:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106495:	e9 6d f3 ff ff       	jmp    80105807 <alltraps>
...
8010649a:	6a 00                	push   $0x0
  pushl $203
8010649c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801064a1:	e9 61 f3 ff ff       	jmp    80105807 <alltraps>
...
801064a6:	6a 00                	push   $0x0
  pushl $204
801064a8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801064ad:	e9 55 f3 ff ff       	jmp    80105807 <alltraps>
...
801064b2:	6a 00                	push   $0x0
  pushl $205
801064b4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801064b9:	e9 49 f3 ff ff       	jmp    80105807 <alltraps>
...
801064be:	6a 00                	push   $0x0
  pushl $206
801064c0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801064c5:	e9 3d f3 ff ff       	jmp    80105807 <alltraps>
...
801064ca:	6a 00                	push   $0x0
  pushl $207
801064cc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801064d1:	e9 31 f3 ff ff       	jmp    80105807 <alltraps>
...
801064d6:	6a 00                	push   $0x0
  pushl $208
801064d8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801064dd:	e9 25 f3 ff ff       	jmp    80105807 <alltraps>
...
801064e2:	6a 00                	push   $0x0
  pushl $209
801064e4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801064e9:	e9 19 f3 ff ff       	jmp    80105807 <alltraps>
...
801064ee:	6a 00                	push   $0x0
  pushl $210
801064f0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801064f5:	e9 0d f3 ff ff       	jmp    80105807 <alltraps>
...
801064fa:	6a 00                	push   $0x0
  pushl $211
801064fc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106501:	e9 01 f3 ff ff       	jmp    80105807 <alltraps>
...
80106506:	6a 00                	push   $0x0
  pushl $212
80106508:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010650d:	e9 f5 f2 ff ff       	jmp    80105807 <alltraps>
...
80106512:	6a 00                	push   $0x0
  pushl $213
80106514:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106519:	e9 e9 f2 ff ff       	jmp    80105807 <alltraps>
...
8010651e:	6a 00                	push   $0x0
  pushl $214
80106520:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106525:	e9 dd f2 ff ff       	jmp    80105807 <alltraps>
...
8010652a:	6a 00                	push   $0x0
  pushl $215
8010652c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106531:	e9 d1 f2 ff ff       	jmp    80105807 <alltraps>
...
80106536:	6a 00                	push   $0x0
  pushl $216
80106538:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010653d:	e9 c5 f2 ff ff       	jmp    80105807 <alltraps>
...
80106542:	6a 00                	push   $0x0
  pushl $217
80106544:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106549:	e9 b9 f2 ff ff       	jmp    80105807 <alltraps>
...
8010654e:	6a 00                	push   $0x0
  pushl $218
80106550:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106555:	e9 ad f2 ff ff       	jmp    80105807 <alltraps>
...
8010655a:	6a 00                	push   $0x0
  pushl $219
8010655c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106561:	e9 a1 f2 ff ff       	jmp    80105807 <alltraps>
...
80106566:	6a 00                	push   $0x0
  pushl $220
80106568:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010656d:	e9 95 f2 ff ff       	jmp    80105807 <alltraps>
...
80106572:	6a 00                	push   $0x0
  pushl $221
80106574:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106579:	e9 89 f2 ff ff       	jmp    80105807 <alltraps>
...
8010657e:	6a 00                	push   $0x0
  pushl $222
80106580:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106585:	e9 7d f2 ff ff       	jmp    80105807 <alltraps>
...
8010658a:	6a 00                	push   $0x0
  pushl $223
8010658c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106591:	e9 71 f2 ff ff       	jmp    80105807 <alltraps>
...
80106596:	6a 00                	push   $0x0
  pushl $224
80106598:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010659d:	e9 65 f2 ff ff       	jmp    80105807 <alltraps>
...
801065a2:	6a 00                	push   $0x0
  pushl $225
801065a4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801065a9:	e9 59 f2 ff ff       	jmp    80105807 <alltraps>
...
801065ae:	6a 00                	push   $0x0
  pushl $226
801065b0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801065b5:	e9 4d f2 ff ff       	jmp    80105807 <alltraps>
...
801065ba:	6a 00                	push   $0x0
  pushl $227
801065bc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801065c1:	e9 41 f2 ff ff       	jmp    80105807 <alltraps>
...
801065c6:	6a 00                	push   $0x0
  pushl $228
801065c8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801065cd:	e9 35 f2 ff ff       	jmp    80105807 <alltraps>
...
801065d2:	6a 00                	push   $0x0
  pushl $229
801065d4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801065d9:	e9 29 f2 ff ff       	jmp    80105807 <alltraps>
...
801065de:	6a 00                	push   $0x0
  pushl $230
801065e0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801065e5:	e9 1d f2 ff ff       	jmp    80105807 <alltraps>
...
801065ea:	6a 00                	push   $0x0
  pushl $231
801065ec:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801065f1:	e9 11 f2 ff ff       	jmp    80105807 <alltraps>
...
801065f6:	6a 00                	push   $0x0
  pushl $232
801065f8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801065fd:	e9 05 f2 ff ff       	jmp    80105807 <alltraps>
...
80106602:	6a 00                	push   $0x0
  pushl $233
80106604:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106609:	e9 f9 f1 ff ff       	jmp    80105807 <alltraps>
...
8010660e:	6a 00                	push   $0x0
  pushl $234
80106610:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106615:	e9 ed f1 ff ff       	jmp    80105807 <alltraps>
...
8010661a:	6a 00                	push   $0x0
  pushl $235
8010661c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106621:	e9 e1 f1 ff ff       	jmp    80105807 <alltraps>
...
80106626:	6a 00                	push   $0x0
  pushl $236
80106628:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010662d:	e9 d5 f1 ff ff       	jmp    80105807 <alltraps>
...
80106632:	6a 00                	push   $0x0
  pushl $237
80106634:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106639:	e9 c9 f1 ff ff       	jmp    80105807 <alltraps>
...
8010663e:	6a 00                	push   $0x0
  pushl $238
80106640:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106645:	e9 bd f1 ff ff       	jmp    80105807 <alltraps>
...
8010664a:	6a 00                	push   $0x0
  pushl $239
8010664c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106651:	e9 b1 f1 ff ff       	jmp    80105807 <alltraps>
...
80106656:	6a 00                	push   $0x0
  pushl $240
80106658:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010665d:	e9 a5 f1 ff ff       	jmp    80105807 <alltraps>
...
80106662:	6a 00                	push   $0x0
  pushl $241
80106664:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106669:	e9 99 f1 ff ff       	jmp    80105807 <alltraps>
...
8010666e:	6a 00                	push   $0x0
  pushl $242
80106670:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106675:	e9 8d f1 ff ff       	jmp    80105807 <alltraps>
...
8010667a:	6a 00                	push   $0x0
  pushl $243
8010667c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106681:	e9 81 f1 ff ff       	jmp    80105807 <alltraps>
...
80106686:	6a 00                	push   $0x0
  pushl $244
80106688:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010668d:	e9 75 f1 ff ff       	jmp    80105807 <alltraps>
...
80106692:	6a 00                	push   $0x0
  pushl $245
80106694:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106699:	e9 69 f1 ff ff       	jmp    80105807 <alltraps>
...
8010669e:	6a 00                	push   $0x0
  pushl $246
801066a0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801066a5:	e9 5d f1 ff ff       	jmp    80105807 <alltraps>
...
801066aa:	6a 00                	push   $0x0
  pushl $247
801066ac:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801066b1:	e9 51 f1 ff ff       	jmp    80105807 <alltraps>
...
801066b6:	6a 00                	push   $0x0
  pushl $248
801066b8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801066bd:	e9 45 f1 ff ff       	jmp    80105807 <alltraps>
...
801066c2:	6a 00                	push   $0x0
  pushl $249
801066c4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801066c9:	e9 39 f1 ff ff       	jmp    80105807 <alltraps>
...
801066ce:	6a 00                	push   $0x0
  pushl $250
801066d0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801066d5:	e9 2d f1 ff ff       	jmp    80105807 <alltraps>
...
801066da:	6a 00                	push   $0x0
  pushl $251
801066dc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801066e1:	e9 21 f1 ff ff       	jmp    80105807 <alltraps>
...
801066e6:	6a 00                	push   $0x0
  pushl $252
801066e8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801066ed:	e9 15 f1 ff ff       	jmp    80105807 <alltraps>
...
801066f2:	6a 00                	push   $0x0
  pushl $253
801066f4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801066f9:	e9 09 f1 ff ff       	jmp    80105807 <alltraps>
...
801066fe:	6a 00                	push   $0x0
  pushl $254
80106700:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106705:	e9 fd f0 ff ff       	jmp    80105807 <alltraps>
...
8010670a:	6a 00                	push   $0x0
  pushl $255
8010670c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106711:	e9 f1 f0 ff ff       	jmp    80105807 <alltraps>
80106716:	66 90                	xchg   %ax,%ax
80106718:	66 90                	xchg   %ax,%ax
...
80106725:	89 d6                	mov    %edx,%esi
  ...
  pde = &pgdir[PDX(va)];
80106727:	c1 ea 16             	shr    $0x16,%edx
{
8010672a:	53                   	push   %ebx
  pde = &pgdir[PDX(va)];
8010672b:	8d 3c 90             	lea    (%eax,%edx,4),%edi
{
8010672e:	83 ec 1c             	sub    $0x1c,%esp
  if(*pde & PTE_P){
80106731:	8b 1f                	mov    (%edi),%ebx
80106733:	f6 c3 01             	test   $0x1,%bl
80106736:	74 28                	je     80106760 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106738:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
8010673e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80106744:	c1 ee 0a             	shr    $0xa,%esi
}
80106747:	83 c4 1c             	add    $0x1c,%esp
  return &pgtab[PTX(va)];
...
80106762:	74 34                	je     80106798 <walkpgdir+0x78>
80106764:	e8 37 bd ff ff       	call   801024a0 <kalloc>
80106769:	85 c0                	test   %eax,%eax
8010676b:	89 c3                	mov    %eax,%ebx
8010676d:	74 29                	je     80106798 <walkpgdir+0x78>
    memset(pgtab, 0, PGSIZE);
8010676f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106776:	00 
80106777:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010677e:	00 
8010677f:	89 04 24             	mov    %eax,(%esp)
80106782:	e8 69 de ff ff       	call   801045f0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106787:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010678d:	83 c8 07             	or     $0x7,%eax
80106790:	89 07                	mov    %eax,(%edi)
80106792:	eb b0                	jmp    80106744 <walkpgdir+0x24>
...
801067bb:	8b 7d 08             	mov    0x8(%ebp),%edi
  a = (char*)PGROUNDDOWN((uint)va);
801067be:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
{
801067c4:	89 45 e0             	mov    %eax,-0x20(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801067c7:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
801067cb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
801067ce:	83 4d 0c 01          	orl    $0x1,0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801067d2:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
801067d9:	29 df                	sub    %ebx,%edi
801067db:	eb 18                	jmp    801067f5 <mappages+0x45>
801067dd:	8d 76 00             	lea    0x0(%esi),%esi
    if(*pte & PTE_P)
801067e0:	f6 00 01             	testb  $0x1,(%eax)
801067e3:	75 3d                	jne    80106822 <mappages+0x72>
    *pte = pa | perm | PTE_P;
801067e5:	0b 75 0c             	or     0xc(%ebp),%esi
    if(a == last)
801067e8:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
    *pte = pa | perm | PTE_P;
801067eb:	89 30                	mov    %esi,(%eax)
    if(a == last)
801067ed:	74 29                	je     80106818 <mappages+0x68>
      break;
    a += PGSIZE;
801067ef:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
801067f5:	8b 45 e0             	mov    -0x20(%ebp),%eax
801067f8:	b9 01 00 00 00       	mov    $0x1,%ecx
801067fd:	89 da                	mov    %ebx,%edx
801067ff:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
80106802:	e8 19 ff ff ff       	call   80106720 <walkpgdir>
...
8010680b:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80106821:	c3                   	ret    
      panic("remap");
80106822:	c7 04 24 14 79 10 80 	movl   $0x80107914,(%esp)
...
80106839:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
8010683a:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106840:	83 ec 1c             	sub    $0x1c,%esp
  a = PGROUNDUP(newsz);
80106843:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106849:	39 d3                	cmp    %edx,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
8010684b:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010684e:	72 3b                	jb     8010688b <deallocuvm.part.0+0x5b>
80106850:	eb 5e                	jmp    801068b0 <deallocuvm.part.0+0x80>
...
8010685d:	74 22                	je     80106881 <deallocuvm.part.0+0x51>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010685f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106865:	74 54                	je     801068bb <deallocuvm.part.0+0x8b>
        panic("kfree");
      char *v = P2V(pa);
80106867:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
8010686d:	89 14 24             	mov    %edx,(%esp)
80106870:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106873:	e8 78 ba ff ff       	call   801022f0 <kfree>
      *pte = 0;
80106878:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010687b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
80106881:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106887:	39 f3                	cmp    %esi,%ebx
80106889:	73 25                	jae    801068b0 <deallocuvm.part.0+0x80>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010688b:	31 c9                	xor    %ecx,%ecx
8010688d:	89 da                	mov    %ebx,%edx
8010688f:	89 f8                	mov    %edi,%eax
80106891:	e8 8a fe ff ff       	call   80106720 <walkpgdir>
    if(!pte)
80106896:	85 c0                	test   %eax,%eax
80106898:	75 be                	jne    80106858 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010689a:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
801068a0:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801068a6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801068ac:	39 f3                	cmp    %esi,%ebx
801068ae:	72 db                	jb     8010688b <deallocuvm.part.0+0x5b>
    }
  }
  return newsz;
}
801068b0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801068b3:	83 c4 1c             	add    $0x1c,%esp
801068b6:	5b                   	pop    %ebx
801068b7:	5e                   	pop    %esi
801068b8:	5f                   	pop    %edi
801068b9:	5d                   	pop    %ebp
801068ba:	c3                   	ret    
        panic("kfree");
801068bb:	c7 04 24 a6 72 10 80 	movl   $0x801072a6,(%esp)
801068c2:	e8 99 9a ff ff       	call   80100360 <panic>
...
801068d3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801068d6:	e8 a5 cd ff ff       	call   80103680 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801068db:	31 c9                	xor    %ecx,%ecx
801068dd:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c = &cpus[cpuid()];
801068e2:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
801068e8:	05 80 27 11 80       	add    $0x80112780,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801068ed:	66 89 50 78          	mov    %dx,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068f1:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  lgdt(c->gdt, sizeof(c->gdt));
801068f6:	83 c0 70             	add    $0x70,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801068f9:	66 89 48 0a          	mov    %cx,0xa(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068fd:	31 c9                	xor    %ecx,%ecx
801068ff:	66 89 50 10          	mov    %dx,0x10(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106903:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106908:	66 89 48 12          	mov    %cx,0x12(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010690c:	31 c9                	xor    %ecx,%ecx
8010690e:	66 89 50 18          	mov    %dx,0x18(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106912:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106917:	66 89 48 1a          	mov    %cx,0x1a(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010691b:	31 c9                	xor    %ecx,%ecx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010691d:	c6 40 0d 9a          	movb   $0x9a,0xd(%eax)
80106921:	c6 40 0e cf          	movb   $0xcf,0xe(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106925:	c6 40 15 92          	movb   $0x92,0x15(%eax)
80106929:	c6 40 16 cf          	movb   $0xcf,0x16(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010692d:	c6 40 1d fa          	movb   $0xfa,0x1d(%eax)
80106931:	c6 40 1e cf          	movb   $0xcf,0x1e(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106935:	c6 40 25 f2          	movb   $0xf2,0x25(%eax)
80106939:	c6 40 26 cf          	movb   $0xcf,0x26(%eax)
8010693d:	66 89 50 20          	mov    %dx,0x20(%eax)
  pd[0] = size-1;
80106941:	ba 2f 00 00 00       	mov    $0x2f,%edx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106946:	c6 40 0c 00          	movb   $0x0,0xc(%eax)
8010694a:	c6 40 0f 00          	movb   $0x0,0xf(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010694e:	c6 40 14 00          	movb   $0x0,0x14(%eax)
80106952:	c6 40 17 00          	movb   $0x0,0x17(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106956:	c6 40 1c 00          	movb   $0x0,0x1c(%eax)
8010695a:	c6 40 1f 00          	movb   $0x0,0x1f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010695e:	66 89 48 22          	mov    %cx,0x22(%eax)
80106962:	c6 40 24 00          	movb   $0x0,0x24(%eax)
80106966:	c6 40 27 00          	movb   $0x0,0x27(%eax)
8010696a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
8010696e:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106972:	c1 e8 10             	shr    $0x10,%eax
80106975:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80106979:	8d 45 f2             	lea    -0xe(%ebp),%eax
8010697c:	0f 01 10             	lgdtl  (%eax)
}
8010697f:	c9                   	leave  
80106980:	c3                   	ret    
80106981:	eb 0d                	jmp    80106990 <switchkvm>
80106983:	90                   	nop
80106984:	90                   	nop
80106985:	90                   	nop
80106986:	90                   	nop
...
80106990:	a1 a4 56 11 80       	mov    0x801156a4,%eax
{
...
801069d4:	0f 84 c3 00 00 00    	je     80106a9d <switchuvm+0xed>
  pushcli();
801069da:	e8 61 da ff ff       	call   80104440 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801069df:	e8 1c cc ff ff       	call   80103600 <mycpu>
801069e4:	89 c3                	mov    %eax,%ebx
801069e6:	e8 15 cc ff ff       	call   80103600 <mycpu>
801069eb:	89 c7                	mov    %eax,%edi
801069ed:	e8 0e cc ff ff       	call   80103600 <mycpu>
801069f2:	83 c7 08             	add    $0x8,%edi
801069f5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801069f8:	e8 03 cc ff ff       	call   80103600 <mycpu>
801069fd:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106a00:	ba 67 00 00 00       	mov    $0x67,%edx
80106a05:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
80106a0c:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106a13:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
80106a1a:	83 c1 08             	add    $0x8,%ecx
80106a1d:	c1 e9 10             	shr    $0x10,%ecx
80106a20:	83 c0 08             	add    $0x8,%eax
80106a23:	c1 e8 18             	shr    $0x18,%eax
80106a26:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106a2c:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106a33:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106a39:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106a3e:	e8 bd cb ff ff       	call   80103600 <mycpu>
80106a43:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106a4a:	e8 b1 cb ff ff       	call   80103600 <mycpu>
80106a4f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106a54:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106a58:	e8 a3 cb ff ff       	call   80103600 <mycpu>
80106a5d:	8b 56 08             	mov    0x8(%esi),%edx
80106a60:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80106a66:	89 48 0c             	mov    %ecx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106a69:	e8 92 cb ff ff       	call   80103600 <mycpu>
...
80106a8b:	5d                   	pop    %ebp
  popcli();
80106a8c:	e9 ef d9 ff ff       	jmp    80104480 <popcli>
    panic("switchuvm: no process");
80106a91:	c7 04 24 1a 79 10 80 	movl   $0x8010791a,(%esp)
80106a98:	e8 c3 98 ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
80106a9d:	c7 04 24 45 79 10 80 	movl   $0x80107945,(%esp)
80106aa4:	e8 b7 98 ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106aa9:	c7 04 24 30 79 10 80 	movl   $0x80107930,(%esp)
80106ab0:	e8 ab 98 ff ff       	call   80100360 <panic>
80106ab5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80106af7:	e8 f4 da ff ff       	call   801045f0 <memset>
...
80106b16:	00 
80106b17:	e8 94 fc ff ff       	call   801067b0 <mappages>
  memmove(mem, init, sz);
...
80106b2b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b2c:	e9 5f db ff ff       	jmp    80104690 <memmove>
    panic("inituvm: more than a page");
80106b31:	c7 04 24 59 79 10 80 	movl   $0x80107959,(%esp)
...
80106b83:	e8 98 fb ff ff       	call   80106720 <walkpgdir>
...
80106bbd:	e8 9e ad ff ff       	call   80101960 <readi>
...
80106be2:	c7 04 24 73 79 10 80 	movl   $0x80107973,(%esp)
80106be9:	e8 72 97 ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
80106bee:	c7 04 24 14 7a 10 80 	movl   $0x80107a14,(%esp)
...
80106c43:	e8 a8 d9 ff ff       	call   801045f0 <memset>
...
80106c62:	00 
80106c63:	e8 48 fb ff ff       	call   801067b0 <mappages>
...
80106c81:	c7 04 24 91 79 10 80 	movl   $0x80107991,(%esp)
...
80106cb0:	c7 04 24 a9 79 10 80 	movl   $0x801079a9,(%esp)
...
80106cc9:	e8 62 fb ff ff       	call   80106830 <deallocuvm.part.0>
      kfree(mem);
...
80106ce2:	e8 49 fb ff ff       	call   80106830 <deallocuvm.part.0>
      return 0;
...
80106d00:	5d                   	pop    %ebp
80106d01:	e9 2a fb ff ff       	jmp    80106830 <deallocuvm.part.0>
...
80106d2a:	e8 01 fb ff ff       	call   80106830 <deallocuvm.part.0>
...
80106d73:	e9 78 b5 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106d78:	c7 04 24 c5 79 10 80 	movl   $0x801079c5,(%esp)
...
80106d98:	e8 03 b7 ff ff       	call   801024a0 <kalloc>
80106d9d:	85 c0                	test   %eax,%eax
80106d9f:	89 c6                	mov    %eax,%esi
80106da1:	74 6d                	je     80106e10 <setupkvm+0x80>
...
80106dbb:	e8 30 d8 ff ff       	call   801045f0 <memset>
...
80106dd6:	e8 d5 f9 ff ff       	call   801067b0 <mappages>
...
80106df4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      freevm(pgdir);
80106df8:	89 34 24             	mov    %esi,(%esp)
80106dfb:	e8 10 ff ff ff       	call   80106d10 <freevm>
}
...
80106e12:	eb d8                	jmp    80106dec <setupkvm+0x5c>
...
80106e23:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106e26:	e8 65 ff ff ff       	call   80106d90 <setupkvm>
...
80106e45:	83 ec 18             	sub    $0x18,%esp
  pte = walkpgdir(pgdir, uva, 0);
80106e48:	8b 55 0c             	mov    0xc(%ebp),%edx
80106e4b:	8b 45 08             	mov    0x8(%ebp),%eax
80106e4e:	e8 cd f8 ff ff       	call   80106720 <walkpgdir>
  if(pte == 0)
...
80106e5b:	c3                   	ret    
    panic("clearpteu");
80106e5c:	c7 04 24 d6 79 10 80 	movl   $0x801079d6,(%esp)
80106e63:	e8 f8 94 ff ff       	call   80100360 <panic>
80106e68:	90                   	nop
...
80106e76:	83 ec 2c             	sub    $0x2c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80106e79:	e8 12 ff ff ff       	call   80106d90 <setupkvm>
80106e7e:	85 c0                	test   %eax,%eax
80106e80:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106e83:	0f 84 b9 00 00 00    	je     80106f42 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106e96:	eb 48                	jmp    80106ee0 <copyuvm+0x70>
...
80106e98:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106e9e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106ea5:	00 
80106ea6:	89 74 24 04          	mov    %esi,0x4(%esp)
80106eaa:	89 04 24             	mov    %eax,(%esp)
80106ead:	e8 de d7 ff ff       	call   80104690 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106eb2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106eb5:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106eba:	89 fa                	mov    %edi,%edx
80106ebc:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ec0:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106ec6:	89 04 24             	mov    %eax,(%esp)
80106ec9:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106ecc:	e8 df f8 ff ff       	call   801067b0 <mappages>
80106ed1:	85 c0                	test   %eax,%eax
80106ed3:	78 63                	js     80106f38 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106ed5:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106edb:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80106ede:	76 48                	jbe    80106f28 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106ee0:	8b 45 08             	mov    0x8(%ebp),%eax
80106ee3:	31 c9                	xor    %ecx,%ecx
80106ee5:	89 fa                	mov    %edi,%edx
80106ee7:	e8 34 f8 ff ff       	call   80106720 <walkpgdir>
80106eec:	85 c0                	test   %eax,%eax
80106eee:	74 62                	je     80106f52 <copyuvm+0xe2>
    if(!(*pte & PTE_P))
80106ef0:	8b 00                	mov    (%eax),%eax
80106ef2:	a8 01                	test   $0x1,%al
80106ef4:	74 50                	je     80106f46 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80106ef6:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106ef8:	25 ff 0f 00 00       	and    $0xfff,%eax
80106efd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106f00:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106f06:	e8 95 b5 ff ff       	call   801024a0 <kalloc>
80106f0b:	85 c0                	test   %eax,%eax
80106f0d:	89 c3                	mov    %eax,%ebx
80106f0f:	75 87                	jne    80106e98 <copyuvm+0x28>
    }
  }
  return d;
...
bad:
  freevm(d);
80106f11:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106f14:	89 04 24             	mov    %eax,(%esp)
80106f17:	e8 f4 fd ff ff       	call   80106d10 <freevm>
  return 0;
80106f1c:	31 c0                	xor    %eax,%eax
}
80106f1e:	83 c4 2c             	add    $0x2c,%esp
80106f21:	5b                   	pop    %ebx
80106f22:	5e                   	pop    %esi
80106f23:	5f                   	pop    %edi
80106f24:	5d                   	pop    %ebp
...
80106f2b:	83 c4 2c             	add    $0x2c,%esp
80106f2e:	5b                   	pop    %ebx
80106f2f:	5e                   	pop    %esi
80106f30:	5f                   	pop    %edi
80106f31:	5d                   	pop    %ebp
...
80106f34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
80106f38:	89 1c 24             	mov    %ebx,(%esp)
80106f3b:	e8 b0 b3 ff ff       	call   801022f0 <kfree>
      goto bad;
80106f40:	eb cf                	jmp    80106f11 <copyuvm+0xa1>
    return 0;
80106f42:	31 c0                	xor    %eax,%eax
80106f44:	eb d8                	jmp    80106f1e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106f46:	c7 04 24 fa 79 10 80 	movl   $0x801079fa,(%esp)
80106f4d:	e8 0e 94 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106f52:	c7 04 24 e0 79 10 80 	movl   $0x801079e0,(%esp)
80106f59:	e8 02 94 ff ff       	call   80100360 <panic>
...
80106fac:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
80106fb4:	75 3a                	jne    80106ff0 <copyout+0x50>
80106fb6:	eb 68                	jmp    80107020 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80106fb8:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106fbb:	89 f2                	mov    %esi,%edx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80106fbd:	89 7c 24 04          	mov    %edi,0x4(%esp)
    n = PGSIZE - (va - va0);
80106fc1:	29 ca                	sub    %ecx,%edx
80106fc3:	81 c2 00 10 00 00    	add    $0x1000,%edx
80106fc9:	39 da                	cmp    %ebx,%edx
80106fcb:	0f 47 d3             	cmova  %ebx,%edx
    memmove(pa0 + (va - va0), buf, n);
80106fce:	29 f1                	sub    %esi,%ecx
80106fd0:	01 c8                	add    %ecx,%eax
80106fd2:	89 54 24 08          	mov    %edx,0x8(%esp)
80106fd6:	89 04 24             	mov    %eax,(%esp)
80106fd9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80106fdc:	e8 af d6 ff ff       	call   80104690 <memmove>
    len -= n;
    buf += n;
80106fe1:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    va = va0 + PGSIZE;
80106fe4:	8d 8e 00 10 00 00    	lea    0x1000(%esi),%ecx
    buf += n;
80106fea:	01 d7                	add    %edx,%edi
  while(len > 0){
80106fec:	29 d3                	sub    %edx,%ebx
80106fee:	74 30                	je     80107020 <copyout+0x80>
    pa0 = uva2ka(pgdir, (char*)va0);
80106ff0:	8b 45 08             	mov    0x8(%ebp),%eax
    va0 = (uint)PGROUNDDOWN(va);
80106ff3:	89 ce                	mov    %ecx,%esi
80106ff5:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80106ffb:	89 74 24 04          	mov    %esi,0x4(%esp)
    va0 = (uint)PGROUNDDOWN(va);
80106fff:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80107002:	89 04 24             	mov    %eax,(%esp)
80107005:	e8 56 ff ff ff       	call   80106f60 <uva2ka>
    if(pa0 == 0)
8010700a:	85 c0                	test   %eax,%eax
8010700c:	75 aa                	jne    80106fb8 <copyout+0x18>
  }
  return 0;
}
8010700e:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80107020:	83 c4 1c             	add    $0x1c,%esp
  return 0;
